...
class Section16Rule3(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(Section16Rule3, self).__init__(
            ...
            each_rule=Section16Rule3.BuildingRule(),
            index_rmd="baseline",
            id="16-3",
    ...
    class BuildingRule(RuleDefinitionBase):
        def __init__(self):
            super(Section16Rule3.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_instance(
                    USER=False,
                    BASELINE_0=True,
                    PROPOSED=True,
        ...
        def get_calc_vals(self, context, data=None):
            ...
            cab_ventilation_schedule_b = getattr_(
                building_b,
                "building",
                "elevators",
                "cab_ventilation_fan_multiplier_schedule",
            )
            cab_ventilation_schedule_p = getattr_(
                building_p,
                "building",
                "elevators",
                "cab_ventilation_fan_multiplier_schedule",
        ...
        def rule_check(self, context, calc_vals=None, data=None):
            ...
            cab_ventilation_schedule_b = calc_vals["cab_ventilation_schedule_b"]
            cab_ventilation_schedule_p = calc_vals["cab_ventilation_schedule_p"]

            return (
                compare_schedules["total_hours_matched"]
                == len(cab_ventilation_schedule_b)
                == len(cab_ventilation_schedule_p)
            )
