...
class PRM9012019Rule30t80(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule30t80, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=True), each_rule=PRM9012019Rule30t80.ElevatorRule(),
            index_rmd=BASELINE_0, id='section16rule7', description=
            'When included in the proposed design, the baseline elevator cab lighting power density shall be 3.14 W/ft2.'
