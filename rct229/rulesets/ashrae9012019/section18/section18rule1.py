...
from rct229.rulesets.ashrae9012019.ruleset_functions.g311_exceptions.g311_sub_functions.get_building_lab_zones_list import get_building_lab_zones_list
...
from rct229.rulesets.ashrae9012019.ruleset_functions.g311_exceptions.g311_sub_functions.is_zone_likely_a_vestibule import is_zone_likely_a_vestibule
...
from rct229.rulesets.ashrae9012019.ruleset_functions.get_zone_target_baseline_system import SYSTEMORIGIN, get_zone_target_baseline_system
...
class PRM9012019Rule77j55(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule77j55, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=True), each_rule=PRM9012019Rule77j55.RMDRule(),
            index_rmd=BASELINE_0, id='section18rule1', description=
            'HVAC system type selection is based on ASHRAE 90.1 G3.1.1 (a-h).',
            ruleset_section_title='HVAC - System Zone Assignment',
            standard_section='Table G3.1.1', is_primary_rule=True,
            list_path='ruleset_model_descriptions[0]', required_fields={'$':
    ...
    class RMDRule(RuleDefinitionListIndexedBase):
        ...
        def __init__(self):
            super(PRM9012019Rule77j55.RMDRule, self).__init__(rmds_used=
                produce_ruleset_model_description(USER=False, BASELINE_0=
                True, PROPOSED=True), each_rule=PRM9012019Rule77j55.RMDRule
                .ZoneRule(), index_rmd=BASELINE_0, list_path=
        ...
        def is_applicable(self, context, data=None):
            ...
            zone_target_baseline_system_dict_b = (
                get_zone_target_baseline_system(rmd_b, rmd_p,
        ...
        def create_data(self, context, data):
            ...
            hvac_systems_serving_zone_b = {zone_id_b:
                get_list_hvac_systems_associated_with_zone(rmd_b, zone_id_b
                ) for zone_id_b in zone_ids_list_b}
            is_zone_likely_a_vestibule_b = {zone_id_b:
                is_zone_likely_a_vestibule(rmd_b, zone_id_b) for zone_id_b in
                zone_ids_list_b}
            building_total_lab_exhaust_p = (
                get_building_total_lab_exhaust_from_zone_exhaust_fans(rmd_p))
            return {'zone_target_baseline_system_dict_b':
                zone_target_baseline_system_dict_b,
                'baseline_hvac_system_dict_b': baseline_hvac_system_dict_b,
                'get_building_lab_zones_list_b':
                get_building_lab_zones_list_b,
        ...
        class ZoneRule(RuleDefinitionBase):
            ...
            def __init__(self):
                super(PRM9012019Rule77j55.RMDRule.ZoneRule, self).__init__(
                    ...
                    'building_total_lab_exhaust_p': {'precision': 1, 'unit':
                    'cfm'}})

            def get_calc_vals(self, context, data=None):
                zone_b = context.BASELINE_0
                zone_id_b = zone_b['id']
                expected_system_type_b = data[
                    'zone_target_baseline_system_dict_b'][zone_id_b][
                    'expected_system_type']
                hvac_systems_serving_zone_b = data[
                    'hvac_systems_serving_zone_b'][zone_id_b]
                systems_of_expected_type_list_b = data[
                    'baseline_hvac_system_dict_b'][expected_system_type_b]
                is_system_part_of_expected_sys_type_b = any([(sys_b in
                    systems_of_expected_type_list_b) for sys_b in
            ...
            def manual_check_required(self, context, calc_vals=None, data=None
                ...
                zone_b = context.BASELINE_0
                zone_id_b = zone_b['id']
                is_zone_likely_a_vestibule_b = data[
                    'is_zone_likely_a_vestibule_b']
                building_total_lab_exhaust_p = data[
                    'building_total_lab_exhaust_p']
                system_origin_b = data['zone_target_baseline_system_dict_b'][
                    zone_id_b]['system_origin']
                is_undetermined = False
                if system_origin_b == SYSTEMORIGIN.G311D:
                    is_undetermined = (building_total_lab_exhaust_p <
                        EXHAUST_AIRFLOW_15000 or self.precision_comparison[
                        'building_total_lab_exhaust_p'](
            ...
            def get_fail_msg(self, context, calc_vals=None, data=None):
                ...
                expected_system_type_b = zone_target_baseline_system_dict_b[
                    'expected_system_type']
                return (
                    f'HVAC system type {expected_system_type_b} was selected based on {system_type_origin_b}.'
                    )
