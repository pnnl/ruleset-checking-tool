...
class PRM9012019Rule72a03(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule72a03, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule72a03.BuildingRule(),
            index_rmd=BASELINE_0, id='section5rule2', description=
    ...
    class BuildingRule(RuleDefinitionBase):
        ...
        def __init__(self):
            super(PRM9012019Rule72a03.BuildingRule, self).__init__(rmds_used
                ...
                'adjacent_to'], EXTERIOR_SURFACES_JSONPATH: [
                'does_cast_shade']})

        def get_calc_vals(self, context, data=None):
            baseline_surfaces_casting_shade_ids = []
            for surface in find_all(EXTERIOR_SURFACES_JSONPATH, context.
                BASELINE_0):
                if surface['does_cast_shade']:
                    baseline_surfaces_casting_shade_ids.append(surface['id'])
            return {'baseline_surfaces_casting_shade_ids':
                baseline_surfaces_casting_shade_ids}
