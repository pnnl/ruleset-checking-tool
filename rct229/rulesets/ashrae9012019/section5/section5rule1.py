    ...
    class RMDRule(RuleDefinitionListIndexedBase):
        ...
        class BuildingRule(RuleDefinitionBase):
            ...
            def manual_check_required(self, context, calc_vals=None, data=None):
                ...
                bbp_values = calc_vals["bbp_values"]
                ...
                bbp = next(iter(bbp_values))
                return rotation_expected_b and bbp == baseline_0_total_annual_cost
            ...
            def rule_check(self, context, calc_vals=None, data=None):
                ...
                if (
                    ...
                    and bbp == avg_baseline_total_annual_cost
                ):
                    return True

                # Case 2:
                # rotations NOT expected AND BBP == baseline_0 annual cost
                if not rotation_expected_b and bbp == baseline_0_total_annual_cost:
                    return True
            ...
            def get_fail_msg(self, context, calc_vals=None, data=None):
                ...
                elif rotation_expected_b and bbp != avg_baseline_total_annual_cost:
                    return f"Baseline building performance energy cost ({bbp}) does not equal the average of the four baseline orientation annual costs ({avg_baseline_total_annual_cost})."
                elif not rotation_expected_b and bbp != baseline_0_total_annual_cost:
                    return f"Baseline building performance energy cost ({bbp}) does not equal the baseline (0 degree) annual cost ({baseline_0_total_annual_cost})."
                else:
