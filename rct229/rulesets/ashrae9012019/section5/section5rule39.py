    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(Section5Rule39.BuildingRule, self).__init__(
                rmrs_used=UserBaselineProposedVals(False, False, True),
                each_rule=Section5Rule39.BuildingRule.SubsurfaceRule(),
                index_rmr="proposed",
        ...
        class SubsurfaceRule(PartialRuleDefinition):
            def __init__(self):
                super(Section5Rule39.BuildingRule.SubsurfaceRule, self).__init__(
                    rmrs_used=UserBaselineProposedVals(False, False, True),
            ...
            def applicability_check(self, context, calc_vals, data):
                ...
                return subsurface_dynamic_glazing_type_p == "MANUAL_DYNAMIC"
