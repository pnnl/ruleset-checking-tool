...
MANUAL_CHECK_MSG = (
    'There is a humidity schedule mismatch between the baseline and proposed. Fail unless Table G3.1 #4 baseline column exception #s 1 and/or 2 are applicable'
    )
FAIL_MSG_B = (
    'Fail because a humidity schedule is defined in the baseline but not in the proposed.'
    )
FAIL_MSG_P = (
    'Fail because a humidity schedule is defined in the proposed but not in the baseline.'
    )
...
class PRM9012019Rule85i93(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule85i93, self).__init__(rmds_used=
            ...
            index_rmd=BASELINE_0, id='section4rule2', description=
            'Humidity Control Setpoints shall be the same for proposed design and baseline building design.'
    ...
    class RuleSetModelInstanceRule(RuleDefinitionListIndexedBase):
        ...
        def __init__(self):
            super(PRM9012019Rule85i93.RuleSetModelInstanceRule, self).__init__(
                ...
                PRM9012019Rule85i93.RuleSetModelInstanceRule.ZoneRule(),
        ...
        def create_data(self, context, data=None):
            ...
            return {'schedules_b': rmd_b.get('schedules'), 'schedules_p':
                rmd_p.get('schedules'), 'zcc_dict_b':
        ...
        class ZoneRule(RuleDefinitionBase):
            ...
            def __init__(self):
                super(PRM9012019Rule85i93.RuleSetModelInstanceRule.ZoneRule,
            ...
            def get_calc_vals(self, context, data=None):
                ...
                if maximum_humidity_stpt_sch_id_b:
                    ...
                    maximum_humidity_stpt_hourly_values_b = getattr_(
                        ...
                        schedules_b), 'schedules', 'hourly_values')
                    assert_(len(maximum_humidity_stpt_hourly_values_b) ==
                        number_of_hours,
                ...
                if maximum_humidity_stpt_sch_id_p:
                    ...
                    maximum_humidity_stpt_hourly_values_p = getattr_(
                        ...
                        schedules_p), 'schedules', 'hourly_values')
                    assert_(len(maximum_humidity_stpt_hourly_values_p) ==
                        number_of_hours,
                ...
                return {'minimum_humidity_stpt_sch_id_b':
            ...
            def manual_check_required(self, context, calc_vals=None, data=None
                ...
                maximum_humidity_schedule_type_matched = calc_vals[
                    'maximum_humidity_schedule_type_matched']
                return (minimum_humidity_schedule_type_matched and
                    maximum_humidity_schedule_type_matched and not (
                    minimum_humidity_schedule_matched and
                    maximum_humidity_schedule_matched))
            ...
            def rule_check(self, context, calc_vals=None, data=None):
                ...
                maximum_humidity_schedule_matched = calc_vals[
                    'maximum_humidity_schedule_matched']
                return (minimum_humidity_schedule_matched and
                    maximum_humidity_schedule_matched)
            ...
            def get_fail_msg(self, context, calc_vals=None, data=None):
                ...
                maximum_humidity_stpt_sch_id_b = calc_vals[
                    'maximum_humidity_stpt_sch_id_b']
                return (FAIL_MSG_B if minimum_humidity_stpt_sch_id_b or
                    maximum_humidity_stpt_sch_id_b else FAIL_MSG_P)
