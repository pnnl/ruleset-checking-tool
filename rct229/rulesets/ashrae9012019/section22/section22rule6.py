...
class PRM9012019Rule52t53(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule52t53, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule52t53.
            ChillerFluidLoopRule(), index_rmd=BASELINE_0, id=
            'section22rule6', description=
            'Baseline chilled water loops that do not use purchased chilled water and do serve computer rooms (i.e., baseline system type 11) shall have a maximum reset chilled water supply temperature setpoint of 54F.'
    ...
    class ChillerFluidLoopRule(RuleDefinitionBase):
        ...
        def __init__(self):
            super(PRM9012019Rule52t53.ChillerFluidLoopRule, self).__init__(
                ...
                'cooling_or_condensing_design_and_control': [
                'loop_supply_temperature_at_low_load']}, precision={
                'loop_supply_temperature_at_low_load': {'precision': 1,
                'unit': 'K'}})
        ...
        def get_calc_vals(self, context, data=None):
            ...
            return {'loop_supply_temperature_at_low_load': CalcQ(
        ...
        def is_tolerance_fail(self, context, calc_vals=None, data=None):
            ...
            required_loop_supply_temperature_at_low_load = calc_vals[
                'required_loop_supply_temperature_at_low_load']
            return std_equal(loop_supply_temperature_at_low_load.to(ureg.
                kelvin), required_loop_supply_temperature_at_low_load.to(
                ureg.kelvin))
