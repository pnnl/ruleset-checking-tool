...
class PRM9012019Rule92r39(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule92r39, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule92r39.
            ChillerFluidLoopRule(), index_rmd=BASELINE_0, id=
            'section22rule1', description=
            'Baseline chilled water design supply temperature shall be modeled at 44F.'
    ...
    class ChillerFluidLoopRule(RuleDefinitionBase):
        ...
        def __init__(self):
            super(PRM9012019Rule92r39.ChillerFluidLoopRule, self).__init__(
                ...
                'cooling_or_condensing_design_and_control': [
                'design_supply_temperature']}, precision={
        ...
        def get_calc_vals(self, context, data=None):
            ...
            return {'design_supply_temperature': CalcQ('temperature',
                ...
                CalcQ('temperature', DESIGN_SUPPLY_TEMP)}
