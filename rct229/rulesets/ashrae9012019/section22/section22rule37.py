...
class PRM9012019Rule81j88(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule81j88, self).__init__(
            ...
            manual_check_required_msg="Manual Check Required - Baseline is modeled with purchased chilled water. Make sure baseline systems served by purchased chilled water are modeled with a variable speed drive pump.",
