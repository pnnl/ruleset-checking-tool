...
class PRM9012019Rule88r57(RuleDefinitionBase):
    ...
    def __init__(self):
        super(PRM9012019Rule88r57, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), id='section22rule33', description=
            'Baseline chilled water systems that do not use purchased chilled water shall have only one set of primary/secondary chilled water loops.'
    ...
    def get_calc_vals(self, context, data=None):
        ...
        num_secondary_loops = sum([len(primary_secondary_loop_dict[
            primary_loop]) for primary_loop in primary_secondary_loop_dict])
