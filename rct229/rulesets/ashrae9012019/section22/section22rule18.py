...
class PRM9012019Rule38d92(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule38d92, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule38d92.
            HeatRejectionRule(), index_rmd=BASELINE_0, id='section22rule18',
            description=
            'The baseline heat rejection device shall be modeled with variable speed fan control.'
    ...
    class HeatRejectionRule(RuleDefinitionBase):
        ...
        def rule_check(self, context, calc_vals=None, data=None):
            ...
            return (fan_speed_control_b == HEATREJECTIONFANSPEEDCONTROL.
                VARIABLE_SPEED)
