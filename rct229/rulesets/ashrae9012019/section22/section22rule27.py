...
class PRM9012019Rule86p62(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule86p62, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule86p62.ChillerRule(),
            index_rmd=BASELINE_0, id='section22rule27', description=
            'Each baseline chiller shall be modeled with separate condenser water pump interlocked to operate with the associated chiller.'
    ...
    class ChillerRule(RuleDefinitionBase):
        ...
        def __init__(self):
            super(PRM9012019Rule86p62.ChillerRule, self).__init__(rmds_used
