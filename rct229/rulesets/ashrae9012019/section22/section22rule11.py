...
class PRM9012019Rule57w94(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule57w94, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule57w94.
            ChillerFluidLoopRule(), index_rmd=BASELINE_0, id=
            'section22rule11', description=
            'Baseline chilled water systems that do not use purchased chilled water shall have a variable-flow secondary pump power of 13 W/gpm at design conditions.'
    ...
    class ChillerFluidLoopRule(RuleDefinitionListIndexedBase):
        ...
        def __init__(self):
            super(PRM9012019Rule57w94.ChillerFluidLoopRule, self).__init__(
                ...
                PRM9012019Rule57w94.ChillerFluidLoopRule.
        ...
        class SecondaryChildLoopRule(RuleDefinitionBase):
            ...
            def __init__(self):
                super(PRM9012019Rule57w94.ChillerFluidLoopRule.
                    ...
                    'secondary_loop_pump_power_per_flow_rate': {'precision':
                    1, 'unit': 'W/gpm'}})
            ...
            def get_calc_vals(self, context, data=None):
                ...
                return {'secondary_loop_pump_power_per_flow_rate': CalcQ(
            ...
            def is_tolerance_fail(self, context, calc_vals=None, data=None):
                secondary_loop_pump_power_per_flow_rate = calc_vals[
                    'secondary_loop_pump_power_per_flow_rate']
                req_pump_flow_rate = calc_vals['req_pump_flow_rate']
                return std_equal(secondary_loop_pump_power_per_flow_rate,
                    req_pump_flow_rate)
