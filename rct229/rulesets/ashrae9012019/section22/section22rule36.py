...
class Section22Rule36(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(Section22Rule36, self).__init__(
            ...
            id="22-36",
            description="Baseline chilled water systems that do not use purchased chilled water shall be modeled with constant flow primary loop and variable flow secondary loop.",
