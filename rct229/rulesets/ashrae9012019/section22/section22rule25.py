...
class Section22Rule25(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(Section22Rule25, self).__init__(
            ...
            id="22-25",
            description="Baseline chilled water loops that do not use purchased chilled water and do not serve computer rooms (baseline system type 11) shall have a constant-flow primary pump power of 9 W/gpm at design conditions.",
