...
class PRM9012019Rule36t85(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule36t85, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule36t85.
            CoolingFluidLoopRule(), index_rmd=BASELINE_0, id=
            'section22rule34', description=
            'Baseline chilled water loops that do not use purchased chilled water shall have the plant equipment capacity sized based on coincident loads.'
            , ruleset_section_title='HVAC - Chiller', standard_section=
            'Section G3.1.2.2 Building System-Specific Modeling Requirements for the Baseline model'
