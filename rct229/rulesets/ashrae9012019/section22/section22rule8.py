...
class PRM9012019Rule37a05(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule37a05, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule37a05.
            PrimaryFluidLoopRule(), index_rmd=BASELINE_0, id=
            'section22rule8', description=
            'Baseline chilled water systems with a cooling capacity of 300 tons or more shall have the secondary chilled water pump modeled with variable-speed drives.'
            ...
            'ruleset_model_descriptions[0].fluid_loops[*]', precision={
            'chw_loop_capacity': {'precision': 1, 'unit': 'ton'}})
    ...
    def create_data(self, context, data):
        ...
        for chiller in find_all('$.chillers[*]', rmd_b):
            ...
            chw_loop_capacity_dict[cooling_loop_id] += getattr_(chiller,
        ...
        return {'loop_pump_dict': loop_pump_dict, 'chw_loop_capacity_dict':
            chw_loop_capacity_dict, 'primary_loop_ids': primary_loop_ids}
    ...
    def list_filter(self, context_item, data):
        ...
        return fluid_loop_b['id'] in primary_loop_ids and (
            ...
            MIN_CHW_PRIMARY_LOOP_COOLING_CAPACITY or self.
            precision_comparison['chw_loop_capacity'](
            chw_loop_capacity_dict[fluid_loop_b['id']],
    ...
    class PrimaryFluidLoopRule(RuleDefinitionListIndexedBase):
        ...
        def __init__(self):
            super(PRM9012019Rule37a05.PrimaryFluidLoopRule, self).__init__(
                ...
                PRM9012019Rule37a05.PrimaryFluidLoopRule.
        ...
        class SecondaryChildLoopRule(RuleDefinitionListIndexedBase):
            ...
            def __init__(self):
                super(PRM9012019Rule37a05.PrimaryFluidLoopRule.
