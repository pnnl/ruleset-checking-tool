...
from rct229.rulesets.ashrae9012019.data_fns.table_3_1_3_11_fns import table_3_1_3_11_lookup
...
class PRM9012019Rule71o81(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule71o81, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule71o81.
            HeatRejectionRule(), index_rmd=BASELINE_0, id='section22rule20',
            description=
            'The baseline heat rejection device leaving water temperature shall be modeled as specified in Table G3.1.3.11.'
    ...
    class HeatRejectionRule(RuleDefinitionBase):
        ...
        def __init__(self):
            super(PRM9012019Rule71o81.HeatRejectionRule, self).__init__(
                ...
                'leaving_water_setpoint_temperature']}, precision={
                'tower_leaving_temperature_b': {'precision': 0.1, 'unit': 'K'}}
                )

        def get_calc_vals(self, context, data=None):
            heat_rejection_b = context.BASELINE_0
            tower_leaving_temperature_b = table_3_1_3_11_lookup(data[
                'climate_zone'])['leaving_water_temperature']
            leaving_water_setpoint_temperature_b = heat_rejection_b[
                'leaving_water_setpoint_temperature']
            return {'tower_leaving_temperature_b': CalcQ('temperature',
                tower_leaving_temperature_b),
                'leaving_water_setpoint_temperature_b': CalcQ('temperature',
        ...
        def is_tolerance_fail(self, context, calc_vals=None, data=None):
            ...
            leaving_water_setpoint_temperature_b = calc_vals[
                'leaving_water_setpoint_temperature_b']
            return std_equal(tower_leaving_temperature_b.to(ureg.kelvin),
                leaving_water_setpoint_temperature_b.to(ureg.kelvin))
