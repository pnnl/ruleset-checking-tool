...
class PRM9012019Rule96z66(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule96z66, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule96z66.ChillerRule(),
            index_rmd=BASELINE_0, id='section22rule21', description=
            'The baseline chiller plant shall be modeled with chiller(s) having the type as indicated in Table G3.1.3.7 as a function of building peak cooling load.'
            ...
            'ruleset_model_descriptions/0', list_path='$.chillers[*]',
    ...
    def create_data(self, context, data):
        ...
        building_cooling_peak_load = getattr_(output_b,
    ...
    class ChillerRule(RuleDefinitionBase):
        ...
        def __init__(self):
            super(PRM9012019Rule96z66.ChillerRule, self).__init__(rmds_used
        ...
        def get_calc_vals(self, context, data=None):
            ...
            target_chiller_type = (CHILLER_COMPRESSOR.SCREW if 
                building_cooling_peak_load <
                REQUIRED_BUILDING_PEAK_LOAD_600 else CHILLER_COMPRESSOR.
                CENTRIFUGAL)
