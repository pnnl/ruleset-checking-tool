...
class PRM9012019Rule20a97(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule20a97, self).__init__(
            ...
            manual_check_required_msg="Manual Check Required - Baseline is modeled with purchased chilled water. Make sure baseline systems served by purchased chilled water are not modeled with chilled water reset.",
