...
class PRM9012019Rule41d32(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule41d32, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule41d32.
            HeatRejectionRule(), index_rmd=BASELINE_0, id='section22rule28',
            description=
            'The baseline building design condenser water pump shall be modeled as constant volume.'
    ...
    def create_data(self, context, data):
        ...
        fluid_loop_b = {heat_rej_b['id']: find_exactly_one_fluid_loop(rmd_b,
            getattr_(heat_rej_b, 'heat_rejections', 'loop')) for heat_rej_b in
            find_all('$.heat_rejections[*]', rmd_b)}
    ...
    class HeatRejectionRule(RuleDefinitionBase):
        ...
        def get_calc_vals(self, context, data=None):
            ...
            heat_rejection_flow_ctrl_b = getattr_(heat_rej_fluid_loop_b,
                'heat_rejections',
        ...
        def rule_check(self, context, calc_vals=None, data=None):
            ...
            return (heat_rejection_flow_ctrl_b == FLUID_LOOP_FLOW_CONTROL.
                FIXED_FLOW)
