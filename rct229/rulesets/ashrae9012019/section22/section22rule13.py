...
class PRM9012019Rule92d16(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule92d16, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule92d16.
            HeatRejectionRule(), index_rmd=BASELINE_0, id='section22rule13',
            description=
            'The baseline heat rejection device shall be an axial-fan open circuit cooling tower.'
    ...
    class HeatRejectionRule(RuleDefinitionBase):
        ...
        def is_applicable(self, context, data=None):
            ...
            heat_rejection_loop_b = getattr_(heat_rejection_b,
        ...
        def get_calc_vals(self, context, data=None):
            ...
            return {'fan_type_b': fan_type_b, 'heat_rejection_type_b':
                heat_rejection_type_b}

        def rule_check(self, context, calc_vals=None, data=None):
            fan_type_b = calc_vals['fan_type_b']
            heat_rejection_type_b = calc_vals['heat_rejection_type_b']
            return (fan_type_b == HEATREJECTIONFAN.AXIAL and 
                heat_rejection_type_b == HEATREJECTION.
                OPEN_CIRCUIT_COOLING_TOWER)
