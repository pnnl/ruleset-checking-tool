...
class PRM9012019Rule78g49(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule78g49, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule78g49.
            ChillerFluidLoopRule(), index_rmd=BASELINE_0, id=
            'section22rule9', description=
            'Baseline chilled water systems with a cooling capacity of 300 tons or more shall have the secondary loop modeled with a minimum flow of 25% of the design flow rate.'
    ...
    def list_filter(self, context_item, data):
        ...
        return fluid_loop_b['id'
            ] in primary_secondary_loop_dict and chw_loop_capacity_dict[
            fluid_loop_b['id']] >= MIN_CHW_PRIMARY_LOOP_COOLING_CAPACITY
    ...
    class ChillerFluidLoopRule(RuleDefinitionListIndexedBase):
        ...
        def __init__(self):
            super(PRM9012019Rule78g49.ChillerFluidLoopRule, self).__init__(
                ...
                PRM9012019Rule78g49.ChillerFluidLoopRule.
        ...
        class SecondaryChildLoopRule(RuleDefinitionBase):
            ...
            def __init__(self):
                super(PRM9012019Rule78g49.ChillerFluidLoopRule.
                    ...
                    'cooling_or_condensing_design_and_control': [
                    'minimum_flow_fraction']}, precision={
                    'min_flow_fraction': {'precision': 0.1}})
