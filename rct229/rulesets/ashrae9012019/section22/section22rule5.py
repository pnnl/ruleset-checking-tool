...
class Section22Rule5(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(Section22Rule5, self).__init__(
            ...
            id="22-5",
            description="Baseline chilled water loops that do not use purchased chilled water and do serve computer rooms (baseline system type 11) shall have the chilled water supply temperature reset higher based on the HVAC system requiring the most cooling.",
