...
class PRM9012019Rule79u84(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule79u84, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule79u84.
            CondensingFluidLoopRule(), index_rmd=BASELINE_0, id=
            'section22rule30', description=
            'Baseline chilled water loops that do not use purchased chilled water and do serve computer rooms (i.e., baseline system type 11) shall have a condenser water pump power of 22 W/gpm at design conditions.'
    ...
    def create_data(self, context, data):
        ...
        condenser_loop_pump_power_dict = {chiller['condensing_loop']:
            ...
            get('pump_power_per_flow_rate') for chiller in find_all(
            '$.chillers[*]', rmd_b)}
