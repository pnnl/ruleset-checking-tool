...
APPLICABLE_SYS_TYPES = [HVAC_SYS.SYS_11_1, HVAC_SYS.SYS_11_2, HVAC_SYS.
    SYS_11_1B]
...
class PRM9012019Rule18j38(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule18j38, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule18j38.
            PrimaryCoolingFluidLoop(), index_rmd=BASELINE_0, id=
            'section22rule26', description=
            'Baseline chilled water loops that do not use purchased chilled water and do serve computer rooms (i.e., baseline system type 11) shall have a constant-flow primary pump power of 12 W/gpm at design conditions.'
    ...
    def is_applicable(self, context, data=None):
        ...
        return any([(available_type in APPLICABLE_SYS_TYPES) for
            available_type in available_sys_types]) and len(
