...
APPLICABLE_SYS_TYPES = [HVAC_SYS.SYS_7, HVAC_SYS.SYS_8, HVAC_SYS.SYS_11_1,
    HVAC_SYS.SYS_11_2, HVAC_SYS.SYS_12, HVAC_SYS.SYS_13, HVAC_SYS.SYS_1A,
    HVAC_SYS.SYS_3A, HVAC_SYS.SYS_7A, HVAC_SYS.SYS_8A, HVAC_SYS.SYS_11_1A,
    HVAC_SYS.SYS_11_2A, HVAC_SYS.SYS_12A, HVAC_SYS.SYS_13A, HVAC_SYS.SYS_7B,
    HVAC_SYS.SYS_8B, HVAC_SYS.SYS_11_1B, HVAC_SYS.SYS_12B, HVAC_SYS.SYS_1C,
    HVAC_SYS.SYS_3C, HVAC_SYS.SYS_7C, HVAC_SYS.SYS_11_1C]
...
class PRM9012019Rule59b18(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule59b18, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule59b18.
            ChillerFluidLoopRule(), index_rmd=BASELINE_0, id=
            'section22rule2', description=
            'Baseline chilled water design return temperature shall be modeled at 56F.'
            , ruleset_section_title='HVAC - Chiller', standard_section=
            'Section G3.1.3.8 Chilled-water design supply temperature (System 7, 8, 11, 12 and 13)'
    ...
    class ChillerFluidLoopRule(RuleDefinitionBase):
        ...
        def __init__(self):
            super(PRM9012019Rule59b18.ChillerFluidLoopRule, self).__init__(
                ...
                'cooling_or_condensing_design_and_control': [
                'design_return_temperature']}, precision={
                'design_return_temperature': {'precision': 1, 'unit': 'K'}})
        ...
        def get_calc_vals(self, context, data=None):
            ...
            return {'design_return_temperature': CalcQ('temperature',
                design_return_temperature), 'required_return_temperature':
                CalcQ('temperature', DESIGN_RETURN_TEMP)}
        ...
        def is_tolerance_fail(self, context, calc_vals=None, data=None):
            ...
            required_return_temperature = calc_vals[
                'required_return_temperature']
            return std_equal(design_return_temperature.to(ureg.kelvin),
                required_return_temperature.to(ureg.kelvin))
