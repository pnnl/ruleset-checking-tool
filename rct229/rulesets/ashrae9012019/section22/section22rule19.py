...
class PRM9012019Rule68h16(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule68h16, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule68h16.
            HeatRejectionRule(), index_rmd=BASELINE_0, id='section22rule19',
            description=
            'The baseline heat rejection device shall be controlled to maintain a constant leaving water temperature.'
    ...
    def create_data(self, context, data):
        rmd_b = context.BASELINE_0
        heat_rejection_loop_dict = {heat_rejection_loop_id:
            find_exactly_one_with_field_value('$.fluid_loops[*]', 'id',
            heat_rejection_loop_id, rmd_b) for heat_rejection_loop_id in
            find_all('$.heat_rejections[*].loop', rmd_b)}
    ...
    class HeatRejectionRule(RuleDefinitionBase):
        ...
        def get_calc_vals(self, context, data=None):
            ...
            temperature_reset_type = getattr_(data[
