...
class PRM9012019Rule58a51(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule58a51, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule58a51.
            ChillerFluidLoopRule(), index_rmd=BASELINE_0, id=
            'section22rule3', description=
            'Baseline chilled water loops that do not use purchased cooling and do not serve any computer rooms (i.e., do not serve baseline system type 11) shall have the chilled water supply temperature reset based on outdoor dry-bulb temperature.'
