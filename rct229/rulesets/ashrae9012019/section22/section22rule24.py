...
class PRM9012019Rule47d94(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule47d94, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule47d94.PrimaryPumpRule(
            ), index_rmd=BASELINE_0, id='section22rule24', description=
            'Baseline chilled water loops that do not use purchased chilled water shall have the primary pump modeled as constant volume.'
    ...
    class PrimaryPumpRule(RuleDefinitionBase):
        ...
        def __init__(self):
            super(PRM9012019Rule47d94.PrimaryPumpRule, self).__init__(rmds_used
                =produce_ruleset_model_description(USER=False, BASELINE_0=
                True, PROPOSED=False), required_fields={'$': ['speed_control']}
                )
