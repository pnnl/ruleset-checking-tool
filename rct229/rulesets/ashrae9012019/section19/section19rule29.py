...
class PRM9012019Rule20z34(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule20z34, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule20z34.HVACRule(),
            index_rmd=BASELINE_0, id='section19rule29', description=
            ...
            'Table G3.1-4 Schedules proposed building column excluding exceptions #s 2 and 3 and G3.1.2.4.'
    ...
    def create_data(self, context, data):
        ...
        inapplicable_hvac_sys_list_b = list(set(
    ...
    class HVACRule(RuleDefinitionBase):
        ...
        def __init__(self):
            super(PRM9012019Rule20z34.HVACRule, self).__init__(rmds_used=
