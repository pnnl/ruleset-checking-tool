...
class Section19Rule20(RuleDefinitionListIndexedBase):
    ...
    class HVACRule(RuleDefinitionBase):
        ...
        def get_calc_vals(self, context, data=None):
            ...
            return {
                "hvac_sys_total_supply_fan_power_b": CalcQ("electric_power", hvac_sys_total_supply_fan_power_b),
                "hvac_sys_total_return_fan_power_b": CalcQ("electric_power", hvac_sys_total_return_fan_power_b),
                "hvac_sys_total_exhaust_fan_power_b": CalcQ("electric_power", hvac_sys_total_exhaust_fan_power_b),
                "hvac_sys_total_relief_fan_power_b": CalcQ("electric_power", hvac_sys_total_relief_fan_power_b),
                "expected_baseline_fan_power_supply": CalcQ("electric_power", total_modeled_fan_power_b
                * fraction_of_total_supply_p),
                "expected_baseline_fan_power_return": CalcQ("electric_power", total_modeled_fan_power_b
                * fraction_of_total_return_p),
                "expected_baseline_fan_power_exhaust": CalcQ("electric_power", total_modeled_fan_power_b
                * fraction_of_total_exhaust_p),
                "expected_baseline_fan_power_relief": CalcQ("electric_power", total_modeled_fan_power_b
                * fraction_of_total_relief_p),
            }
