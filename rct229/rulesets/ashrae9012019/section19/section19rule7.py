...
class PRM9012019Rule29n92(RuleDefinitionListIndexedBase):
    ...
    def create_data(self, context, data):
        ...
        for hvac_id_b in find_all(
            ...
            for zone_id_b in dict_of_zones_and_terminal_units_served_by_hvac_sys_b[
                ...
                zone_data[hvac_id_b]["was_DCV_modeled_baseline"] = any(
                    [
                        ...
                        for terminal_b in find_all(
                            "$.terminals[*]", find_exactly_one_zone(rmd_b, zone_id_b)
                        )
                    ]
                )
                ...
                ] = (getattr_(zone_p, "zones", "air_distribution_effectiveness") > 1)
            zone_data[hvac_id_b][
    ...
    class HVACRule(RuleDefinitionBase):
        ...
        def is_applicable(self, context, data=None):
            ...
            return (
                not hvac_system_serves_only_labs
                or hvac_system_serves_only_labs
                and not all_lighting_space_types_defined
            )
        ...
        def manual_check_required(self, context, calc_vals=None, data=None):
            ...
            return (
                ...
                or modeled_baseline_total_zone_min_OA_CFM
                < modeled_proposed_total_zone_min_OA_CFM
            )
