            ...
            for hvac_id_b in find_all(
                ...
                for zone_id_b in dict_of_zones_and_terminal_units_served_by_hvac_sys_b[
                    ...
                    (
                        ...
                        in space_lighting_space_type_list_p
                        or VENTILATION_SPACE.MISCELLANEOUS_SPACES_MANUFACTURING_WHERE_HAZARDOUS_MATERIALS_ARE_USED_EXCLUDES_HEAVY_INDUSTRIAL_AND_CHEMICAL_PROCESSES
        ...
        class HVACRule(RuleDefinitionBase):
            ...
            def get_calc_vals(self, context, data=None):
                ...
                ER_modeled_b = find_one(
                    "$.fan_system.air_energy_recovery.energy_recovery_operation", hvac_b
                ) not in (None, ENERGY_RECOVERY.NONE)
                ER_modeled_p = find_one(
                    "$.fan_system.air_energy_recovery.energy_recovery_operation", hvac_p
                ) not in (None, ENERGY_RECOVERY.NONE)
                exception_1_applies = (
            ...
            def manual_check_required(self, context, calc_vals=None, data=None):
                ...
                return (
                    ...
                    not ER_modeled_p
                    and serves_kitchen_space_p
                    or num_hvac_exhaust_fans_b > 1
            ...
            def rule_check(self, context, calc_vals=None, data=None):
                ...
                return (
                    ...
                    and (
                        ER_modeled_b
                        or exception_1_applies
                        or exception_2_applies
                        or ER_not_req_for_heating_sys_b
                        and sys_type_heating_only_b
                        or exception_6_applies
                        or exception_7_applies
                    )
                    or (
                        OA_fraction_b < OA_fraction_b_70
