...
class PRM9012019Rule20g60(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule20g60, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=False,
            PROPOSED=True), each_rule=PRM9012019Rule20g60.HVACRule(),
            index_rmd=PROPOSED, id='section19rule28', description=
            ...
            'Table G3.1-4 Schedules for the proposed building excluding exceptions #s 2 and 3 and Section G3.1.2.4.'
    ...
    class HVACRule(RuleDefinitionBase):
        ...
        def __init__(self):
            super(PRM9012019Rule20g60.HVACRule, self).__init__(rmds_used=
