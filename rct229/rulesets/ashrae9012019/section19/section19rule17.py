...
class PRM9012019Rule84b07(RuleDefinitionListIndexedBase):
    ...
    def create_data(self, context, data):
        ...
        return {
            ...
            "dict_of_zones_and_terminal_units_served_by_hvac_sys": get_dict_of_zones_and_terminal_units_served_by_hvac_sys(
                rmd_b
            ),
    ...
    class HVACRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012019Rule84b07.HVACRule, self).__init__(
                ...
                precision={"fan_power_airflow": {"precision": 0.1, "unit": "W/cfm"}},
            )
