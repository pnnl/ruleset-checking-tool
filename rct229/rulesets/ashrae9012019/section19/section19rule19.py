...
class PRM9012019Rule51d17(RuleDefinitionListIndexedBase):
    ...
    def create_data(self, context, data):
        ...
        for zone_id_p in find_all(
            ...
            zone_map[zone_id_p] = any([(find_one(
                '$.cooling_system.cooling_system',
                find_exactly_one_hvac_system(rmd_p, hvac_id_p)) ==
                COOLING_SYSTEM.NON_MECHANICAL) for hvac_id_p in
                get_list_hvac_systems_associated_with_zone(rmd_p, zone_id_p)])
        hvac_map = {}
        for hvac_id_b in find_all(
            '$.buildings[*].building_segments[*].heating_ventilating_air_conditioning_systems[*].id'
            , rmd_b):
            hvac_map[hvac_id_b] = {'zonal_exhaust_fan_elec_power_b': ZERO.
                POWER, 'zones_served_by_hvac_has_non_mech_cooling_bool_p': 
                False}
            for zone_id_b in dict_of_zones_and_terminal_units_served_by_hvac_sys_b[
                ...
                hvac_map[hvac_id_b]['zonal_exhaust_fan_elec_power_b'
                    ] += get_fan_object_electric_power(zone_b.get(
                    'zonal_exhaust_fan'))
                hvac_map[hvac_id_b].update({
                    'zones_served_by_hvac_has_non_mech_cooling_bool_p': 
                    zone_p.get('non_mechanical_cooling_fan_airflow') is not
                    None and zone_p['non_mechanical_cooling_fan_airflow'] >
                    ZERO.FLOW})
        return {'applicable_hvac_sys_ids': applicable_hvac_sys_ids,
            'dict_of_zones_and_terminal_units_served_by_hvac_sys_b':
            dict_of_zones_and_terminal_units_served_by_hvac_sys_b,
            'zone_map': zone_map, 'hvac_map': hvac_map}
    ...
    class HVACRule(RuleDefinitionBase):
        ...
        def __init__(self):
            super(PRM9012019Rule51d17.HVACRule, self).__init__(rmds_used=
                produce_ruleset_model_description(USER=False, BASELINE_0=
                True, PROPOSED=True), required_fields={'$': ['fan_system']},
                precision={'fan_power_per_flow_b': {'precision': 0.1,
                'unit': 'W/cfm'}})
        ...
        def get_calc_vals(self, context, data=None):
            ...
            zone_hvac_has_non_mech_cooling_p = any([zone_dict_b[zone_id_p] for
                zone_id_p in
                dict_of_zones_and_terminal_units_served_by_hvac_sys_b[
                hvac_id_b]['zone_list']])
        ...
        def manual_check_required(self, context, calc_vals=None, data=None):
            ...
            zones_served_by_hvac_has_non_mech_cooling_bool_p = calc_vals[
                'zones_served_by_hvac_has_non_mech_cooling_bool_p']
            return more_than_one_supply_fan_b or (fan_power_per_flow_b >
                REQ_FAN_POWER_FLOW_RATIO or self.precision_comparison[
                'fan_power_per_flow_b'](fan_power_per_flow_b,
                REQ_FAN_POWER_FLOW_RATIO)) and (
                zone_hvac_has_non_mech_cooling_p or
                zones_served_by_hvac_has_non_mech_cooling_bool_p)
        ...
        def rule_check(self, context, calc_vals=None, data=None):
            ...
            zone_hvac_has_non_mech_cooling_p = calc_vals[
                'zone_hvac_has_non_mech_cooling_p']
            fan_power_per_flow_b = calc_vals['fan_power_per_flow_b']
            return (not zone_hvac_has_non_mech_cooling_p and not
                zones_served_by_hvac_has_non_mech_cooling_bool_p and self.
                precision_comparison['fan_power_per_flow_b'](
                fan_power_per_flow_b, REQ_FAN_POWER_FLOW_RATIO) or 
        ...
        def is_tolerance_fail(self, context, calc_vals=None, data=None):
            ...
            fan_power_per_flow_b = calc_vals['fan_power_per_flow_b']
            return (not zone_hvac_has_non_mech_cooling_p and not
                zones_served_by_hvac_has_non_mech_cooling_bool_p and
                std_equal(REQ_FAN_POWER_FLOW_RATIO, fan_power_per_flow_b) or
                fan_power_per_flow_b < REQ_FAN_POWER_FLOW_RATIO)
        ...
        def get_fail_msg(self, context, calc_vals=None, data=None):
            ...
            fail_msg = ''
            if (not more_than_one_supply_fan_b and fan_power_per_flow_b <
                REQ_FAN_POWER_FLOW_RATIO):
                fail_msg = (
                    f'Rule evaluation fails with a conservative outcome. The fan power airflow (W/cfm) for {hvac_id_b} is modeled as {fan_power_per_flow_b.magnitude} W/cfm which is less than the expected W/cfm.'
                    )
            return fail_msg
