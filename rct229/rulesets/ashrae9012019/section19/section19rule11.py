...
class PRM9012019Rule18u58(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule18u58, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule18u58.HVACRule(),
            index_rmd=BASELINE_0, id='section19rule11', description=
            'For systems that serve computer rooms, if the baseline system is HVAC System 11, it shall include an integrated fluid economizer meeting the requirements of Section 6.5.1.2 in the baseline building design.'
            , ruleset_section_title='HVAC - General', standard_section=
            'Section G3.1.2.6.1', is_primary_rule=False, rmd_context=
    ...
    class HVACRule(PartialRuleDefinition):
        ...
        def __init__(self):
            super(PRM9012019Rule18u58.HVACRule, self).__init__(rmds_used=
        ...
        def get_manual_check_required_msg(self, context, calc_vals=None,
            ...
            hvac_id_b = hvac_b['id']
            return (
                f'{hvac_id_b} was modeled as baseline system type 11-1, conduct a manual check that an integrated fluid economizer meeting the requirements of Section 6.5.1.2 was modeled in the baseline building design.'
                )
