...
class Section19Rule11(RuleDefinitionListIndexedBase):
    ...
    class HVACRule(PartialRuleDefinition):
        ...
        def get_manual_check_required_msg(self, context, calc_vals=None, data=None):
            ...
            return f"{hvac_id_b} was modeled as baseline system type 11, conduct a manual check that an integrated fluid economizer meeting the requirements of Section 6.5.1.2 was modeled in the baseline building design."
