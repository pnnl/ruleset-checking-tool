        ...
        class SWHUseRule(RuleDefinitionBase):
            ...
            def get_calc_vals(self, context, data=None):
                ...
                return {
                    ...
                    "swh_use_temperature_at_fixture_b": CalcQ("temperature", get_swh_use_b(
                        "temperature_at_fixture"
                    )),
                    "swh_use_temperature_at_fixture_p": CalcQ("temperature", get_swh_use_p(
                        "temperature_at_fixture"
                    )),
                    ...
                    "swh_use_design_supply_water_temperature_b": CalcQ("temperature", swh_use_design_supply_water_temperature_b),
                    "swh_use_design_supply_water_temperature_p": CalcQ("temperature", swh_use_design_supply_water_temperature_p),
