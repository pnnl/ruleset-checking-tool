...
class PRM9012022Rule03z22(RuleDefinitionListIndexedBase):
    """Rule 5 of ASHRAE 90.1-2019 Appendix G Section 11 (Service Water Heating)"""

    def __init__(self):
        super(PRM9012022Rule03z22, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=False, PROPOSED=True
            ),
            each_rule=PRM9012022Rule03z22.RMDRule(),
            index_rmd=PROPOSED,
            id="11-5",
    ...
    class RMDRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule03z22.RMDRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=False, PROPOSED=True
                ),
                each_rule=PRM9012022Rule03z22.RMDRule.SWHDistRule(),
                index_rmd=PROPOSED,
        ...
        class SWHDistRule(RuleDefinitionBase):
            def __init__(self):
                super(PRM9012022Rule03z22.RMDRule.SWHDistRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False,
                        BASELINE_0=False,
                        PROPOSED=True,
