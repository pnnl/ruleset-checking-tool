...
class PRM9012019Rule29n09(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule29n09, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule29n09.RMDRule(),
            index_rmd=BASELINE_0, id='section11rule6', description=
            'Piping losses shall not be modeled.', ruleset_section_title=
            'Service Water Heating', standard_section=
            'Table G3.1 #11, baseline column, i', is_primary_rule=True,
    ...
    class RMDRule(RuleDefinitionListIndexedBase):
        ...
        def __init__(self):
            super(PRM9012019Rule29n09.RMDRule, self).__init__(rmds_used=
                produce_ruleset_model_description(USER=False, BASELINE_0=
                True, PROPOSED=False), each_rule=PRM9012019Rule29n09.
                RMDRule.SWHDistRule(), index_rmd=BASELINE_0, list_path=
        ...
        class SWHDistRule(RuleDefinitionBase):
            ...
            def get_calc_vals(self, context, data=None):
                ...
                for service_water_piping in swh_dist_sys_b[
                    'service_water_piping']:
                    ...
                    while queue:
                        ...
                        piping_losses_modeled_b.append(current_piping.get(
