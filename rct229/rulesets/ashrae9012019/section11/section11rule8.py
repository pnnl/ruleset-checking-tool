...
CASE3_MSG = "The Service Water Heating Building Area type for this building segment is undetermined, and there are multiple building segments in the project. Therefore it cannot be determined whether this building segment shares a service water heating building area type with one of the other building segments."
CASE4_MSG = "The Service Water Heating Building Area Type is 'OTHER' and is applied to multiple building segments. 'OTHER' can describe multiple Service Water Heating Building Area Types. Confirm that Service Water Heating Building Area Type is provided with one and only one service water heating system."
    ...
    class RMDRule(RuleDefinitionListIndexedBase):
        ...
        class SWHBATRule(RuleDefinitionBase):
            ...
            def manual_check_required(self, context, calc_vals=None, data=None):
                ...
                return (
                    swh_bat_b == "UNDETERMINED"
                    and num_of_bldg_segment_b > 1
                    or swh_bat_b == SERVICE_WATER_HEATING_SPACE.ALL_OTHERS
