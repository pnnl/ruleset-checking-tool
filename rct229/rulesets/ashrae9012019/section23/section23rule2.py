...
class PRM9012019Rule52x31(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule52x31, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule52x31.HVACRule(),
            index_rmd=BASELINE_0, id='section23rule2', description=
            'For baseline systems 5-8 and 11, the SAT is reset higher by 5F under minimum cooling load conditions.'
            , ruleset_section_title='HVAC - Airside', standard_section=
            'Section G3.1.3.12 Supply Air Temperature Reset (Systems 5 through 8 and 11)'
    ...
    class HVACRule(RuleDefinitionBase):
        ...
        def __init__(self):
            super(PRM9012019Rule52x31.HVACRule, self).__init__(rmds_used=
                ...
                'reset_differential_temperature']}, precision={
                'reset_differential_temperature_b': {'precision': 0.1,
                'unit': 'K'}})
        ...
        def get_calc_vals(self, context, data=None):
            ...
            return {'fan_system_id': fan_system_id_b,
        ...
        def rule_check(self, context, calc_vals=None, data=None):
            ...
            return (temperature_control_b == FanSystemTemperatureControl.
        ...
        def is_tolerance_fail(self, context, calc_vals=None, data=None):
            ...
            reset_differential_temperature_b = calc_vals[
                'reset_differential_temperature_b']
            return (temperature_control_b == FanSystemTemperatureControl.
                ZONE_RESET and std_equal(reset_differential_temperature_b,
