...
class PRM9012019Rule18u93(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule18u93, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule18u93.HVACRule(),
            index_rmd=BASELINE_0, id='section23rule10', description=
            'System 11 Fan volume shall be reset from 100% airflow at 100% cooling load to minimum airflow at 50% cooling load. '
    ...
    class HVACRule(RuleDefinitionBase):
        ...
        def __init__(self):
            super(PRM9012019Rule18u93.HVACRule, self).__init__(rmds_used=
                produce_ruleset_model_description(USER=False, BASELINE_0=
                True, PROPOSED=False), required_fields={'$': ['fan_system']
                }, precision={'fan_volume_reset_fraction_b': {'precision': 
                0.1}})
        ...
        def get_calc_vals(self, context, data=None):
            ...
            return {'fan_volume_reset_fraction': fan_system_b.get(
                'fan_volume_reset_fraction'), 'fan_volume_reset_type':
                fan_system_b.get('fan_volume_reset_type')}
        ...
        def rule_check(self, context, calc_vals=None, data=None):
            ...
            return (fan_volume_reset_type_b ==
                FAN_SYSTEM_SUPPLY_FAN_VOLUME_RESET.DESIGN_LOAD_RESET and
                self.precision_comparison['fan_volume_reset_fraction_b'](
