...
class PRM9012019Rule71f87(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule71f87, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=True), each_rule=PRM9012019Rule71f87.HVACRule(),
            index_rmd=PROPOSED, id='section23rule15', description=
            'Dehumidification reheat shall be the same as the system heating type.'
    ...
    class HVACRule(PartialRuleDefinition):
        ...
        def __init__(self):
            super(PRM9012019Rule71f87.HVACRule, self).__init__(rmds_used=
