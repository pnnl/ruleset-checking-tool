...
class PRM9012019Rule62j00(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule62j00, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule62j00.HVACRule(),
            index_rmd=BASELINE_0, id='section23rule7', description=
            'Systems 6&8: Supply air temperature setpoint shall be constant at the design condition.'
    ...
    class HVACRule(RuleDefinitionBase):
        ...
        def __init__(self):
            super(PRM9012019Rule62j00.HVACRule, self).__init__(rmds_used=
        ...
        def get_calc_vals(self, context, data=None):
            ...
            return {'temperature_control_b': CalcQ('temperature',
                temperature_control_b)}

        def rule_check(self, context, calc_vals=None, data=None):
            temperature_control_b = calc_vals['temperature_control_b']
            return (temperature_control_b == FANSYSTEM_TEMPERATURE_CONTROL.
                CONSTANT)
