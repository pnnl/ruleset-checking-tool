...
class PRM9012019Rule69z86(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule69z86, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule69z86.TerminalRule(),
            index_rmd=BASELINE_0, id='section23rule5', description=
            'For baseline systems 6 and 8, Fans in parallel VAV fan-powered boxes shall run as the first stage of heating before the reheat coil is energized.'
            , ruleset_section_title='HVAC - Airside', standard_section=
            'G3.1.3.14 Fan Power and Control (Systems 6 and 8)',
    ...
    def create_data(self, context, data):
        ...
        hvac_sys_6_or_8_list = flatten([baseline_system_types_dict[
            system_type] for system_type in baseline_system_types_dict for
            applicable_sys_type in APPLICABLE_SYS_TYPES if 
            baseline_system_types_dict[system_type] and
    ...
    class TerminalRule(RuleDefinitionBase):
        ...
        def __init__(self):
            super(PRM9012019Rule69z86.TerminalRule, self).__init__(rmds_used
        ...
        def is_applicable(self, context, data=None):
            ...
            served_by_hvac_b = getattr_(terminal_b, 'terminals',
                'served_by_heating_ventilating_air_conditioning_system')
            return served_by_hvac_b in hvac_sys_6_or_8_list

        def get_calc_vals(self, context, data=None):
            terminal_b = context.BASELINE_0
            is_fan_first_stage_heat_b = getattr_(terminal_b, 'terminals',
