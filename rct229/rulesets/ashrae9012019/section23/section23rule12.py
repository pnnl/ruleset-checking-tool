...
class PRM9012019Rule71k98(PartialRuleDefinition):
    ...
    def __init__(self):
        super(PRM9012019Rule71k98, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), id='section23rule12', description=
            'System 11 in heating mode supply air temperature shall be modulated to maintain space temp and airflow shall be fixed at minimum airflow.'
            , ruleset_section_title='HVAC - Airside', standard_section=
            'G3.1.3.17 System 11 Supply Air Temperature and Fan Control',
            is_primary_rule=False, rmd_context='ruleset_model_descriptions/0')
