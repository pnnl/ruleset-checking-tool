...
class PRM9012019Rule70w33(RuleDefinitionListIndexedBase):
    """Rule 6 of ASHRAE 90.1-2019 Appendix G Section 15 (Transformers)."""

    def __init__(self):
        super(PRM9012019Rule70w33, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=True, BASELINE_0=False, PROPOSED=False
            ),
            each_rule=PRM9012019Rule70w33.TransformerRule(),
            index_rmd=USER,
            id="15-6",
    ...
    class TransformerRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012019Rule70w33.TransformerRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=True, BASELINE_0=False, PROPOSED=False
                ),
                required_fields={
