...
class PRM9012019Rule88q15(RuleDefinitionListIndexedBase):
    """Rule 5 of ASHRAE 90.1-2019 Appendix G Section 15 (Transformers)."""

    def __init__(self):
        super(PRM9012019Rule88q15, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=True, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012019Rule88q15.TransformerRule(),
            index_rmd=USER,
            id="15-5",
    ...
    class TransformerRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012019Rule88q15.TransformerRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=True, BASELINE_0=True, PROPOSED=False
                ),
                required_fields={
