...
class PRM9012019Rule60m79(RuleDefinitionBase):
    ...
    def __init__(self):
        super(PRM9012019Rule60m79, self).__init__(rmds_used=
            ...
            BASELINE_180=True, BASELINE_270=True), id='section1rule4',
            description=
            'The PCI shall be less than or equal to the PCIt when calculated in accordance with Standard 90.1 2019, Section 4.2.1.1'
    ...
    def get_calc_vals(self, context, data=None):
        ...
        return {'pci_target_set': pci_target_set, 'pci_set': pci_set}

    def rule_check(self, context, calc_vals=None, data=None):
        pci_target_set = calc_vals['pci_target_set']
        pci_set = calc_vals['pci_set']
        return len(pci_target_set) == len(pci_set
            ) == 1 and pci_set <= pci_target_set
