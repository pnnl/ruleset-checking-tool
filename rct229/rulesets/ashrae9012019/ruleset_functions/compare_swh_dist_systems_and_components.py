...
def compare_swh_dist_systems_and_components(
    ...
    assert_(
        rmd2_swh_system_and_equip_dict[swh_distribution_id],
    ...
    rmd1_swh_distribution = find_exactly_one_service_water_heating_distribution_system(
        rmd1, swh_distribution_id
    )
    rmd2_swh_equipment_dict = rmd2_swh_system_and_equip_dict[swh_distribution_id]
    rmd2_swh_distribution = find_exactly_one_service_water_heating_distribution_system(
