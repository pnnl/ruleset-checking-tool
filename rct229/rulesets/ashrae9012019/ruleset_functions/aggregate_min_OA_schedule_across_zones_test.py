...
OA_schedule = [[0.2 * ureg("meter")] * 8760, [0.5 * ureg("meter")] * 8760, [0.05 * ureg("meter")] * 8760]
...
def test__aggregate_min_OA_schedule_across_zones__pass():
    assert aggregate_min_OA_schedule_across_zones(OA_schedule) == [0.75 * ureg("meter")] * 8760
