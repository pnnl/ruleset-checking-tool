...
class PRM9012019Rule31d63(RuleDefinitionBase):
    ...
    def __init__(self):
        super(PRM9012019Rule31d63, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), id='section21rule16', description=
            'Baseline shall have only one heating hot water plant.',
    ...
    def get_calc_vals(self, context, data=None):
        rmd_b = context.BASELINE_0
        hhw_loop_count = len(find_all(
            '$..fluid_loops[*][?(@.type = "HEATING")]', rmd_b))
