...
class PRM9012019Rule39a29(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule39a29, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule39a29.
            HeatingFluidLoopRule(), index_rmd=BASELINE_0, id=
            'section21rule9', description=
            'When baseline building includes boilers, Hot Water Pump Power = 19W/gpm.'
