...
class PRM9012019Rule63n48(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule63n48, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule63n48.BoilerRule(),
            index_rmd=BASELINE_0, id='section21rule4', description=
            'When baseline building does not use purchased heat, baseline systems 1,5,7,11,12 shall be modeled with natural draft boilers.'
    ...
    class BoilerRule(RuleDefinitionBase):
        ...
        def __init__(self):
            super(PRM9012019Rule63n48.BoilerRule, self).__init__(rmds_used=
                produce_ruleset_model_description(USER=False, BASELINE_0=
                True, PROPOSED=False), required_fields={'$': ['draft_type']})
