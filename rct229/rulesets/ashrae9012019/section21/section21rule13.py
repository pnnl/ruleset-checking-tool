...
class PRM9012019Rule43l11(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule43l11, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule43l11.
            HeatingFluidLoopRule(), index_rmd=BASELINE_0, id=
            'section21rule13', description=
            'The baseline building design uses boilers or purchased hot water, the hot water pumping system shall be modeled with a minimum turndown ratio of 0.25.'
    ...
    class HeatingFluidLoopRule(RuleDefinitionBase):
        ...
        def get_calc_vals(self, context, data=None):
            ...
            minimum_flow_fraction = heating_fluid_loop_b[
        ...
        def rule_check(self, context, calc_vals=None, data=None):
            ...
            required_minimum_flow_fraction = calc_vals[
                'required_minimum_flow_fraction']
