...
class PRM9012019Rule59p62(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule59p62, self).__init__(rmds_used=
            produce_ruleset_model_description(USER=False, BASELINE_0=True,
            PROPOSED=False), each_rule=PRM9012019Rule59p62.
            HeatingFluidLoopRule(), index_rmd=BASELINE_0, id=
            'section21rule11', description=
            'The baseline building design uses boilers or purchased hot water, the hot water pumping system shall be modeled as primary-only.'
    ...
    class HeatingFluidLoopRule(RuleDefinitionBase):
        ...
        def get_calc_vals(self, context, data=None):
            ...
            return {'has_child_loops': bool(heating_fluid_loop_b.get(
                'child_loops'))}
