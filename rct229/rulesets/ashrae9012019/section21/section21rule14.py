...
class PRM9012019Rule29g28(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(PRM9012019Rule29g28, self).__init__(
            ...
            manual_check_required_msg="Manual Check Required - Baseline is modeled with purchased hot water or steam.  Make sure that a hot water supply reset temperature is not modeled.",
