...
class PRM9012022Rule22a24(RuleDefinitionListIndexedBase):
    """Rule 12 of ASHRAE 90.1-2022 Appendix G Section 21 (Hot water loop)"""

    def __init__(self):
        super(PRM9012022Rule22a24, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule22a24.HeatingFluidLoopRule(),
    ...
    class HeatingFluidLoopRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule22a24.HeatingFluidLoopRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
                required_fields={
