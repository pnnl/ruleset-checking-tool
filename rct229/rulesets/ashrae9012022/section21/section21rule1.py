...
class PRM9012022Rule34f57(RuleDefinitionListIndexedBase):
    """Rule 1 of ASHRAE 90.1-2022 Appendix G Section 21 (HVAC - Water Side)"""

    def __init__(self):
        super(PRM9012022Rule34f57, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=False, PROPOSED=True
            ),
            each_rule=PRM9012022Rule34f57.RulesetModelInstanceRule(),
            index_rmd=PROPOSED,
            id="21-1",
    ...
    class RulesetModelInstanceRule(PartialRuleDefinition):
        def __init__(self):
            super(PRM9012022Rule34f57.RulesetModelInstanceRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=False, PROPOSED=True
                ),
