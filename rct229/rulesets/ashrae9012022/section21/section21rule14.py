...
class PRM9012022Rule29g28(RuleDefinitionListIndexedBase):
    """Rule 14 of ASHRAE 90.1-2022 Appendix G Section 21 (HVAC - Water Side)"""

    def __init__(self):
        super(PRM9012022Rule29g28, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule29g28.RulesetModelInstanceRule(),
    ...
    class RulesetModelInstanceRule(PartialRuleDefinition):
        def __init__(self):
            super(PRM9012022Rule29g28.RulesetModelInstanceRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
            )
