...
class PRM9012022Rule47b05(RuleDefinitionListIndexedBase):
    """Rule 6 of ASHRAE 90.1-2022 Appendix G Section 21 (Hot water loop)"""

    def __init__(self):
        super(PRM9012022Rule47b05, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule47b05.HeatingFluidLoopRule(),
    ...
    class HeatingFluidLoopRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule47b05.HeatingFluidLoopRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
                precision={
