...
class PRM9012022Rule06a67(RuleDefinitionListIndexedBase):
    """Rule 10 of ASHRAE 90.1-2022 Appendix G Section 23 (Hot water loop)"""

    def __init__(self):
        super(PRM9012022Rule06a67, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule06a67.PumpRule(),
    ...
    class PumpRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule06a67.PumpRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
            )
