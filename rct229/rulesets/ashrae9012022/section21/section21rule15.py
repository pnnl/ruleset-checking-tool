...
class PRM9012022Rule62u16(RuleDefinitionListIndexedBase):
    """Rule 15 of ASHRAE 90.1-2022 Appendix G Section 21 (HVAC - Water Side)"""

    def __init__(self):
        super(PRM9012022Rule62u16, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule62u16.RulesetModelInstanceRule(),
    ...
    class RulesetModelInstanceRule(PartialRuleDefinition):
        def __init__(self):
            super(PRM9012022Rule62u16.RulesetModelInstanceRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
            )
