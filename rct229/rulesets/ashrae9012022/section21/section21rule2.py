...
class PRM9012022Rule83m55(RuleDefinitionListIndexedBase):
    """Rule 2 of ASHRAE 90.1-2022 Appendix G Section 21 (HVAC - Water Side)"""

    def __init__(self):
        super(PRM9012022Rule83m55, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=False, PROPOSED=True
            ),
            each_rule=PRM9012022Rule83m55.RulesetModelInstanceRule(),
            index_rmd=PROPOSED,
            id="21-2",
    ...
    class RulesetModelInstanceRule(PartialRuleDefinition):
        def __init__(self):
            super(PRM9012022Rule83m55.RulesetModelInstanceRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=False, PROPOSED=True
                ),
