...
class PRM9012022Rule66c61(RuleDefinitionListIndexedBase):
    """Rule 14 of ASHRAE 90.1-2022 Appendix G Section 4 (Schedules Setpoints)"""

    def __init__(self):
        super(PRM9012022Rule66c61, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=False, PROPOSED=True
            ),
            each_rule=PRM9012022Rule66c61.SpaceRule(),
            index_rmd=PROPOSED,
            id="4-14",
    ...
    class SpaceRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule66c61.SpaceRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=False, PROPOSED=True
                ),
