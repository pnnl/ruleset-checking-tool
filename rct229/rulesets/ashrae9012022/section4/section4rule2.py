...
class PRM9012022Rule85i93(RuleDefinitionListIndexedBase):
    """Rule 2 of ASHRAE 90.1-2022 Appendix G Section 4 (Schedules Setpoints)"""

    def __init__(self):
        super(PRM9012022Rule85i93, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule85i93.RuleSetModelInstanceRule(),
    ...
    class RuleSetModelInstanceRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule85i93.RuleSetModelInstanceRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                each_rule=PRM9012022Rule85i93.RuleSetModelInstanceRule.ZoneRule(),
                index_rmd=BASELINE_0,
        ...
        class ZoneRule(RuleDefinitionBase):
            def __init__(self):
                super(
                    PRM9012022Rule85i93.RuleSetModelInstanceRule.ZoneRule, self
                ).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=True
                    ),
