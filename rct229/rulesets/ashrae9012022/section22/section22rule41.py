...
class PRM9012022Rule68r93(PartialRuleDefinition):
    """Rule 41 of ASHRAE 90.1-2022 Appendix G Section 22 (Chilled water loop)"""

    def __init__(self):
        super(PRM9012022Rule68r93, self).__init__(
