...
class PRM9012022Rule41z21(RuleDefinitionListIndexedBase):
    """Rule 10 of ASHRAE 90.1-2022 Appendix G Section 22 (Chilled water loop)"""

    def __init__(self):
        super(PRM9012022Rule41z21, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule41z21.PrimaryFluidLoopRule(),
    ...
    class PrimaryFluidLoopRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule41z21.PrimaryFluidLoopRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
                each_rule=PRM9012022Rule41z21.PrimaryFluidLoopRule.SecondaryChildLoopRule(),
                index_rmd=BASELINE_0,
        ...
        class SecondaryChildLoopRule(RuleDefinitionListIndexedBase):
            def __init__(self):
                super(
                    PRM9012022Rule41z21.PrimaryFluidLoopRule.SecondaryChildLoopRule,
                    self,
                ).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=False
                    ...
                    index_rmd=BASELINE_0,
                    each_rule=PRM9012022Rule41z21.PrimaryFluidLoopRule.SecondaryChildLoopRule.PumpTypeRule(),
                )
            ...
            class PumpTypeRule(RuleDefinitionBase):
                def __init__(self):
                    super(
                        PRM9012022Rule41z21.PrimaryFluidLoopRule.SecondaryChildLoopRule.PumpTypeRule,
                        self,
                    ).__init__(
                        rmds_used=produce_ruleset_model_description(
                            USER=False, BASELINE_0=True, PROPOSED=False
