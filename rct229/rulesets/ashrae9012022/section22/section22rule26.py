...
class PRM9012022Rule18j38(RuleDefinitionListIndexedBase):
    """Rule 26 of ASHRAE 90.1-2022 Appendix G Section 22 (Hot water loop)"""

    def __init__(self):
        super(PRM9012022Rule18j38, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule18j38.PrimaryCoolingFluidLoop(),
    ...
    class PrimaryCoolingFluidLoop(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule18j38.PrimaryCoolingFluidLoop, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
                required_fields={
