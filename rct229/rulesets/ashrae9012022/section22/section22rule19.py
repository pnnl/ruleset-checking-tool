...
class PRM9012022Rule68h16(RuleDefinitionListIndexedBase):
    """Rule 19 of ASHRAE 90.1-2022 Appendix G Section 22 (Chilled water loop)"""

    def __init__(self):
        super(PRM9012022Rule68h16, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule68h16.HeatRejectionRule(),
    ...
    class HeatRejectionRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule68h16.HeatRejectionRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
            )
