...
class PRM9012022Rule79u84(RuleDefinitionListIndexedBase):
    """Rule 30 of ASHRAE 90.1-2022 Appendix G Section 22 (Chilled water loop)"""

    def __init__(self):
        super(PRM9012022Rule79u84, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule79u84.CondensingFluidLoopRule(),
    ...
    class CondensingFluidLoopRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule79u84.CondensingFluidLoopRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
                precision={
