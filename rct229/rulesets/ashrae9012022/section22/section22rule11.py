...
class PRM9012022Rule57w94(RuleDefinitionListIndexedBase):
    """Rule 11 of ASHRAE 90.1-2022 Appendix G Section 22 (Chilled water loop)"""

    def __init__(self):
        super(PRM9012022Rule57w94, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule57w94.ChillerFluidLoopRule(),
    ...
    class ChillerFluidLoopRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule57w94.ChillerFluidLoopRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
                each_rule=PRM9012022Rule57w94.ChillerFluidLoopRule.SecondaryChildLoopRule(),
                index_rmd=BASELINE_0,
        ...
        class SecondaryChildLoopRule(RuleDefinitionBase):
            def __init__(self):
                super(
                    PRM9012022Rule57w94.ChillerFluidLoopRule.SecondaryChildLoopRule,
                    self,
                ).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=False
