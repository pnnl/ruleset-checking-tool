...
from rct229.rulesets.ashrae9012022.data_fns.table_G3_5_3_fns import table_g3_5_3_lookup
...
class PRM9012022Rule48s83(RuleDefinitionListIndexedBase):
    """Rule 32 of ASHRAE 90.1-2022 Appendix G Section 22 (Chilled water loop)"""

    def __init__(self):
        super(PRM9012022Rule48s83, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule48s83.ChillerRule(),
    ...
    class ChillerRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule48s83.ChillerRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
                precision={
        ...
        def get_calc_vals(self, context, data=None):
            ...
            assert_(
                ...
                "`efficiency_metric_types` and `efficiency_metric_values` must have the same length",
            )
