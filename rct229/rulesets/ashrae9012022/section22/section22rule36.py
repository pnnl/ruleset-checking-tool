...
class PRM9012022Rule01b91(RuleDefinitionListIndexedBase):
    """Rule 36 of ASHRAE 90.1-2022 Appendix G Section 22 (Chilled water loop)"""

    def __init__(self):
        super(PRM9012022Rule01b91, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule01b91.PrimaryFluidlLoop(),
    ...
    class PrimaryFluidlLoop(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule01b91.PrimaryFluidlLoop, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
                required_fields={
