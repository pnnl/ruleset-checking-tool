...
class PRM9012022Rule52t53(RuleDefinitionListIndexedBase):
    """Rule 6 of ASHRAE 90.1-2022 Appendix G Section 22 (Chilled water loop)"""

    def __init__(self):
        super(PRM9012022Rule52t53, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule52t53.ChillerFluidLoopRule(),
    ...
    class ChillerFluidLoopRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule52t53.ChillerFluidLoopRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
                required_fields={
