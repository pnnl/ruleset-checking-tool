...
class PRM9012022Rule30m88(RuleDefinitionBase):
    """Rule 31 of ASHRAE 90.1-2022 Appendix G Section 22 (Chilled water loop)"""

    def __init__(self):
        super(PRM9012022Rule30m88, self).__init__(
