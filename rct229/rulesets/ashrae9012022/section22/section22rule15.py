...
class PRM9012022Rule79g01(RuleDefinitionListIndexedBase):
    """Rule 15 of ASHRAE 90.1-2022 Appendix G Section 22 (Chilled water loop)"""

    def __init__(self):
        super(PRM9012022Rule79g01, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule79g01.HeatRejectionRule(),
    ...
    class HeatRejectionRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule79g01.HeatRejectionRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
                required_fields={
