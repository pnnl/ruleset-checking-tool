...
class PRM9012022Rule48h16(RuleDefinitionBase):
    """Rule 40 of ASHRAE 90.1-2022 Appendix G Section 22 (Chilled water loop)"""

    def __init__(self):
        super(PRM9012022Rule48h16, self).__init__(
