...
class PRM9012022Rule77j55(RuleDefinitionListIndexedBase):
    """Rule 1 of ASHRAE 90.1-2022 Appendix G Section 18 (HVAC - System Zone Assignment)"""

    def __init__(self):
        super(PRM9012022Rule77j55, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule77j55.RMDRule(),
    ...
    class RMDRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule77j55.RMDRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                each_rule=PRM9012022Rule77j55.RMDRule.ZoneRule(),
                index_rmd=BASELINE_0,
        ...
        class ZoneRule(RuleDefinitionBase):
            def __init__(self):
                super(PRM9012022Rule77j55.RMDRule.ZoneRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=True
                    ),
                    precision={
