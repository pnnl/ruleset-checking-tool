...
class PRM9012022Rule02c29(RuleDefinitionListIndexedBase):
    """Rule 6 of ASHRAE 90.1-2022 Appendix G Section 6 (Lighting)"""

    def __init__(self):
        super(PRM9012022Rule02c29, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule02c29.BuildingRule(),
    ...
    class BuildingRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule02c29.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
            )
