...
from rct229.rulesets.ashrae9012022 import COMMON_RMD
from rct229.rulesets.ashrae9012022.data_fns.table_G3_7_fns import table_G3_7_lookup
from rct229.rulesets.ashrae9012022.data_fns.table_G3_8_fns import table_G3_8_lookup
...
class PRM9012022Rule99c05(RuleDefinitionListIndexedBase):
    """Rule 1 of ASHRAE 90.1-2022 Appendix G Section 6 (Lighting)"""

    def __init__(self):
        super(PRM9012022Rule99c05, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=False, PROPOSED=True
            ),
            each_rule=PRM9012022Rule99c05.BuildingSegmentRule(),
    ...
    class BuildingSegmentRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule99c05.BuildingSegmentRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=False, PROPOSED=True
                ),
