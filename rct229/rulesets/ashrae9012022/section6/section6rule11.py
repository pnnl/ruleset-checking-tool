...
SALES_AREA = SchemaEnums.schema_enums[
    "LightingSpaceOptions2019ASHRAE901TG37"
].SALES_AREA

LIGHTING_PURPOSE_TYPE = SchemaEnums.schema_enums[
...
class PRM9012022Rule12d80(RuleDefinitionListIndexedBase):
    ...
    class SpaceRule(RuleDefinitionBase):
        ...
        def get_calc_vals(self, context, data=None):
            ...
            maximum_retail_display_W = 750 + space_p["floor_area"]
            minimum_retail_display_W = 750
            proposed_interior_display_W = sum(
                space_p["power_per_area"] * space_p["floor_area"]
                for interior_lighting_p in space_p["interior_lighting"]
                if interior_lighting_p["purpose_type"] == LIGHTING_PURPOSE_TYPE
            )
            return {
