...
from rct229.rulesets.ashrae9012022.data_fns.table_9_6_1_fns import table_9_6_1_lookup
...
class PRM9012022Rule37d98(RuleDefinitionListIndexedBase):
    """Rule 2 of ASHRAE 90.1-2022 Appendix G Section 6 (Lighting)"""

    def __init__(self):
        super(PRM9012022Rule37d98, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=True, BASELINE_0=False, PROPOSED=True
            ),
            each_rule=PRM9012022Rule37d98.SpaceRule(),
            index_rmd=PROPOSED,
            id="6-2",
    ...
    class SpaceRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule37d98.SpaceRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=True, BASELINE_0=False, PROPOSED=True
                ),
                required_fields={
