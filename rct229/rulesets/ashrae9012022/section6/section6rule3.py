...
class PRM9012022Rule73a47(RuleDefinitionListIndexedBase):
    """Rule 3 of ASHRAE 90.1-2022 Appendix G Section 6 (Lighting)"""

    def __init__(self):
        super(PRM9012022Rule73a47, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=True, BASELINE_0=False, PROPOSED=True
            ),
            each_rule=PRM9012022Rule73a47.BuildingSegmentRule(),
            index_rmd=PROPOSED,
            id="6-3",
    ...
    class BuildingSegmentRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule73a47.BuildingSegmentRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=True, BASELINE_0=False, PROPOSED=True
                ),
                each_rule=PRM9012022Rule73a47.BuildingSegmentRule.SpaceRule(),
                index_rmd=PROPOSED,
        ...
        class SpaceRule(RuleDefinitionBase):
            def __init__(self):
                super(PRM9012022Rule73a47.BuildingSegmentRule.SpaceRule, self).__init__(
                    fail_msg=FAIL_MSG,
