...
class PRM9012022Rule08a45(RuleDefinitionListIndexedBase):
    """Rule 5 of ASHRAE 90.1-2022 Appendix G Section 6 (Lighting)"""

    def __init__(self):
        super(PRM9012022Rule08a45, self).__init__(
            id="6-5",
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule08a45.RulesetModelInstanceRule(),
    ...
    class RulesetModelInstanceRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule08a45.RulesetModelInstanceRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                each_rule=PRM9012022Rule08a45.RulesetModelInstanceRule.BuildingRule(),
                index_rmd=BASELINE_0,
                list_path="buildings[*]",
                required_fields={
                    "$": ["schedules"],
        ...
        class BuildingRule(RuleDefinitionListIndexedBase):
            def __init__(self):
                super(
                    PRM9012022Rule08a45.RulesetModelInstanceRule.BuildingRule, self
                ).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=True
                    ),
                    each_rule=PRM9012022Rule08a45.RulesetModelInstanceRule.BuildingRule.ZoneRule(),
                    index_rmd=BASELINE_0,
            ...
            class ZoneRule(RuleDefinitionListIndexedBase):
                def __init__(self):
                    super(
                        PRM9012022Rule08a45.RulesetModelInstanceRule.BuildingRule.ZoneRule,
                        self,
                    ).__init__(
                        rmds_used=produce_ruleset_model_description(
                            USER=False, BASELINE_0=True, PROPOSED=True
                        ),
                        each_rule=PRM9012022Rule08a45.RulesetModelInstanceRule.BuildingRule.ZoneRule.SpaceRule(),
                        index_rmd=BASELINE_0,
                        list_path="spaces[*]",
                    )
                ...
                class SpaceRule(RuleDefinitionBase):
                    def __init__(self):
                        super(
                            PRM9012022Rule08a45.RulesetModelInstanceRule.BuildingRule.ZoneRule.SpaceRule,
                            self,
                        ).__init__(
                            rmds_used=produce_ruleset_model_description(
                                USER=False, BASELINE_0=True, PROPOSED=True
