...
from rct229.rulesets.ashrae9012022.data_fns.table_G3_7_fns import table_G3_7_lookup
...
class PRM9012022Rule22l93(RuleDefinitionListIndexedBase):
    """Rule 4 of ASHRAE 90.1-2022 Appendix G Section 6 (Lighting)"""

    def __init__(self):
        super(PRM9012022Rule22l93, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule22l93.BuildingSegmentRule(),
    ...
    class BuildingSegmentRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule22l93.BuildingSegmentRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                each_rule=PRM9012022Rule22l93.BuildingSegmentRule.ZoneRule(),
                index_rmd=BASELINE_0,
                list_path="zones[*]",
            )
        ...
        class ZoneRule(RuleDefinitionListIndexedBase):
            def __init__(self):
                super(PRM9012022Rule22l93.BuildingSegmentRule.ZoneRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=True
                    ),
                    each_rule=PRM9012022Rule22l93.BuildingSegmentRule.ZoneRule.SpaceRule(),
                    index_rmd=BASELINE_0,
                    list_path="spaces[*]",
                )
            ...
            class SpaceRule(RuleDefinitionBase):
                def __init__(self):
                    super(
                        PRM9012022Rule22l93.BuildingSegmentRule.ZoneRule.SpaceRule, self
                    ).__init__(
                        fail_msg=FAIL_MSG,
                        rmds_used=produce_ruleset_model_description(
                            USER=False, BASELINE_0=True, PROPOSED=True
