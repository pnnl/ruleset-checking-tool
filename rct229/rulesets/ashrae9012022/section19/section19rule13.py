...
from rct229.rulesets.ashrae9012022.ruleset_functions.are_all_hvac_sys_fan_objects_autosized import (
...
class PRM9012022Rule77j17(RuleDefinitionListIndexedBase):
    """Rule 13 of ASHRAE 90.1-2022 Appendix G Section 19 (HVAC - General)"""

    def __init__(self):
        super(PRM9012022Rule77j17, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule77j17.HVACRule(),
    ...
    class HVACRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule77j17.HVACRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
