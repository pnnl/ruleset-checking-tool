...
class PRM9012022Rule10q01(RuleDefinitionListIndexedBase):
    """Rule 25 of ASHRAE 90.1-2022 Appendix G Section 19 (HVAC - General)"""

    def __init__(self):
        super(PRM9012022Rule10q01, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=True, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule10q01.HVACRule(),
    ...
    class HVACRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule10q01.HVACRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
