...
class PRM9012022Rule54e25(RuleDefinitionListIndexedBase):
    """Rule 24 of ASHRAE 90.1-2022 Appendix G Section 19 (HVAC - General)"""

    def __init__(self):
        super(PRM9012022Rule54e25, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=True, BASELINE_0=False, PROPOSED=True
            ),
            each_rule=PRM9012022Rule54e25.HVACRule(),
            index_rmd=PROPOSED,
            id="19-24",
    ...
    class HVACRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule54e25.HVACRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
