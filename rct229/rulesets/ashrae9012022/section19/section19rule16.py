...
class PRM9012022Rule04f07(RuleDefinitionListIndexedBase):
    """Rule 16 of ASHRAE 90.1-2022 Appendix G Section 19 (HVAC - General)"""

    def __init__(self):
        super(PRM9012022Rule04f07, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule04f07.ZoneRule(),
    ...
    class ZoneRule(PartialRuleDefinition):
        def __init__(self):
            super(PRM9012022Rule04f07.ZoneRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
            )
