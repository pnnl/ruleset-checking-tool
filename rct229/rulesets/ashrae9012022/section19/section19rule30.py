...
class PRM9012022Rule95r49(RuleDefinitionListIndexedBase):
    """Rule 30 of ASHRAE 90.1-2022 Appendix G Section 19 (HVAC - General)"""

    def __init__(self):
        super(PRM9012022Rule95r49, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule95r49.HVACRule(),
    ...
    class HVACRule(PartialRuleDefinition):
        def __init__(self):
            super(PRM9012022Rule95r49.HVACRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
            )
