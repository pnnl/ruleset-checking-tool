...
class PRM9012022Rule28i68(RuleDefinitionListIndexedBase):
    """Rule 33 of ASHRAE 90.1-2022 Appendix G Section 19 (HVAC - General)"""

    def __init__(self):
        super(PRM9012022Rule28i68, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=True, BASELINE_0=False, PROPOSED=True
            ),
            each_rule=PRM9012022Rule28i68.HVACRule(),
            index_rmd=PROPOSED,
            id="19-33",
    ...
    class HVACRule(PartialRuleDefinition):
        def __init__(self):
            super(PRM9012022Rule28i68.HVACRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
