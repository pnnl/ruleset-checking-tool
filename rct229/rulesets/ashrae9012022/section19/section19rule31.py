...
class PRM9012022Rule58x03(RuleDefinitionListIndexedBase):
    """Rule 31 of ASHRAE 90.1-2022 Appendix G Section 19 (HVAC - General)"""

    def __init__(self):
        super(PRM9012022Rule58x03, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=False, PROPOSED=True
            ),
            each_rule=PRM9012022Rule58x03.HVACRule(),
            index_rmd=PROPOSED,
            id="19-31",
    ...
    class HVACRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule58x03.HVACRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=False, PROPOSED=True
                ),
                required_fields={
        ...
        def is_applicable(self, context, data=None):
            ...
            return (
                hvac_id_p in hvac_systems_primarily_serving_comp_room_p
                and not always_on
            )
