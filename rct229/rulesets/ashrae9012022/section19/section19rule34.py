...
from rct229.rulesets.ashrae9012022.ruleset_functions.get_proposed_hvac_modeled_with_virtual_heating import (
    get_proposed_hvac_modeled_with_virtual_heating,
)
from rct229.utils.assertions import getattr_


class PRM9012022Rule87f72(RuleDefinitionListIndexedBase):
    """Rule 34 of ASHRAE 90.1-2022 Appendix G Section 19 (HVAC - General)"""

    def __init__(self):
        super(PRM9012022Rule87f72, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=True, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule87f72.HVACRule(),
    ...
    class HVACRule(PartialRuleDefinition):
        def __init__(self):
            super(PRM9012022Rule87f72.HVACRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
