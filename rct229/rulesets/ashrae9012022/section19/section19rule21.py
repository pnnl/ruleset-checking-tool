...
class PRM9012022Rule07w16(RuleDefinitionListIndexedBase):
    """Rule 21 of ASHRAE 90.1-2022 Appendix G Section 19 (HVAC - General)"""

    def __init__(self):
        super(PRM9012022Rule07w16, self).__init__(
            ...
            each_rule=PRM9012022Rule07w16.RMDRule(),
    ...
    class RMDRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule07w16.RMDRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                each_rule=PRM9012022Rule07w16.RMDRule.HVACRule(),
                index_rmd=BASELINE_0,
        ...
        class HVACRule(RuleDefinitionBase):
            def __init__(self):
                super(PRM9012022Rule07w16.RMDRule.HVACRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=True
                    ),
                    required_fields={
