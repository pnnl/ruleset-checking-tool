...
class PRM9012022Rule60o81(RuleDefinitionListIndexedBase):
    """Rule 23 of ASHRAE 90.1-2022 Appendix G Section 19 (HVAC - General)"""

    def __init__(self):
        super(PRM9012022Rule60o81, self).__init__(
    ...
    class RMDRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule60o81.RMDRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
        ...
        class BuildingSegmentRule(RuleDefinitionListIndexedBase):
            def __init__(self):
                super(PRM9012022Rule60o81.RMDRule.BuildingSegmentRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=False
                    ),
            ...
            class ZoneRule(RuleDefinitionListIndexedBase):
                def __init__(self):
                    super(
                        PRM9012022Rule60o81.RMDRule.BuildingSegmentRule.ZoneRule, self
                    ).__init__(
                        rmds_used=produce_ruleset_model_description(
                            USER=False, BASELINE_0=True, PROPOSED=False
                        ),
                ...
                class SpaceRule(RuleDefinitionBase):
                    def __init__(self):
                        super(
                            PRM9012022Rule60o81.RMDRule.BuildingSegmentRule.ZoneRule.SpaceRule,
                            self,
                        ).__init__(
                            rmds_used=produce_ruleset_model_description(
                                USER=False, BASELINE_0=True, PROPOSED=False
