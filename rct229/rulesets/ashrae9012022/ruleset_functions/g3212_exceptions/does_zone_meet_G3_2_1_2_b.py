...
from rct229.rulesets.ashrae9012022.ruleset_functions.g3212_exceptions.g3212_sub_functions.get_building_lab_zones_list import (
    get_building_lab_zones_list,
)
from rct229.rulesets.ashrae9012022.ruleset_functions.g3212_exceptions.g3212_sub_functions.get_building_total_lab_exhaust_from_zone_exhaust_fans import (
...
def does_zone_meet_g3_2_1_2_b(rmd: dict, zone_id: str) -> bool:
    """
