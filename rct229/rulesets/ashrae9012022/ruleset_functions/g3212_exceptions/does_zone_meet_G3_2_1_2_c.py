from rct229.rulesets.ashrae9012022.ruleset_functions.g3212_exceptions.g3212_sub_functions.is_zone_likely_a_vestibule import (
    is_zone_likely_a_vestibule,
)
from rct229.rulesets.ashrae9012022.ruleset_functions.g3212_exceptions.g3212_sub_functions.is_zone_mechanically_heated_and_not_cooled import (
...
def does_zone_meet_g3_2_1_2_c(rmd_b: dict, rmd_p: dict, zone_id: str) -> bool:
    """
    determines whether a given zone meets the G3_2_1_2c exception "Thermal zones designed with heating-only systems in
