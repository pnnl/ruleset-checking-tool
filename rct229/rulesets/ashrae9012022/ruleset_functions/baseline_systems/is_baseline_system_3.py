...
from rct229.rulesets.ashrae9012022.ruleset_functions.baseline_systems.baseline_hvac_sub_functions.are_all_terminal_fans_null import (
    are_all_terminal_fans_null,
)
from rct229.rulesets.ashrae9012022.ruleset_functions.baseline_systems.baseline_hvac_sub_functions.are_all_terminal_heat_sources_none_or_null import (
    are_all_terminal_heat_sources_none_or_null,
)
from rct229.rulesets.ashrae9012022.ruleset_functions.baseline_systems.baseline_hvac_sub_functions.are_all_terminal_supplies_ducted import (
    are_all_terminal_supplies_ducted,
)
from rct229.rulesets.ashrae9012022.ruleset_functions.baseline_systems.baseline_hvac_sub_functions.are_all_terminal_types_CAV import (
...
from rct229.rulesets.ashrae9012022.ruleset_functions.baseline_systems.baseline_hvac_sub_functions.does_hvac_system_serve_single_zone import (
    does_hvac_system_serve_single_zone,
)
from rct229.rulesets.ashrae9012022.ruleset_functions.baseline_systems.baseline_hvac_sub_functions.is_hvac_sys_cooling_type_DX import (
...
from rct229.rulesets.ashrae9012022.ruleset_functions.baseline_systems.baseline_hvac_sub_functions.is_hvac_sys_fan_sys_CV import (
...
from rct229.rulesets.ashrae9012022.ruleset_functions.baseline_systems.baseline_hvac_sub_functions.is_hvac_sys_fluid_loop_purchased_heating import (
    is_hvac_sys_fluid_loop_purchased_heating,
)
from rct229.rulesets.ashrae9012022.ruleset_functions.baseline_systems.baseline_hvac_sub_functions.is_hvac_sys_heating_type_fluid_loop import (
    is_hvac_sys_heating_type_fluid_loop,
)
from rct229.rulesets.ashrae9012022.ruleset_functions.baseline_systems.baseline_hvac_sub_functions.is_hvac_sys_heating_type_furnace import (
...
def is_baseline_system_3(rmd_b, hvac_b_id, terminal_unit_id_list, zone_id_list):
    ...
    ----------
    rmd_b json
        To evaluate if the hvac system is modeled as either Sys-3, Sys-3a, Sys-3b, Sys-3c, or Not_Sys_3 in the B_RMD.
    ...
    if are_sys_data_matched:
        if is_hvac_sys_cooling_type_dx(rmd_b, hvac_b_id):
            if is_hvac_sys_heating_type_furnace(rmd_b, hvac_b_id):
                is_baseline_system_3 = HVAC_SYS.SYS_3
            elif is_hvac_sys_heating_type_fluid_loop(
                rmd_b, hvac_b_id
            ) and is_hvac_sys_fluid_loop_purchased_heating(rmd_b, hvac_b_id):
                is_baseline_system_3 = HVAC_SYS.SYS_3B
        elif is_hvac_sys_cooling_type_fluid_loop(
            rmd_b, hvac_b_id
        ) and is_hvac_sys_fluid_loop_purchased_chw(rmd_b, hvac_b_id):
            if is_hvac_sys_heating_type_furnace(rmd_b, hvac_b_id):
