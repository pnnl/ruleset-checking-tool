from rct229.rulesets.ashrae9012022.ruleset_functions.baseline_systems.baseline_hvac_sub_functions.are_all_terminal_chw_loops_purcahsed_cooling import (
    are_all_terminal_chw_loops_purchased_cooling,
)
from rct229.rulesets.ashrae9012022.ruleset_functions.baseline_systems.baseline_hvac_sub_functions.are_all_terminal_cool_sources_chilled_water import (
...
def is_baseline_system_9b(rmd_b, hvac_b_id, terminal_unit_id_list, zone_id_list):
    ...
    Parameters
     ----------
     rmd_b json
         To evaluate if the hvac system is modeled as either Sys-9bin the B_RMD.
     hvac_b_id list
