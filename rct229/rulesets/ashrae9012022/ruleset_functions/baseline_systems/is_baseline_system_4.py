...
from rct229.rulesets.ashrae9012022.ruleset_functions.baseline_systems.baseline_hvac_sub_functions.is_hvac_sys_heating_type_heat_pump import (
...
def is_baseline_system_4(rmd_b, hvac_b_id, terminal_unit_id_list, zone_id_list):
    """
     ...
     ----------
     rmd_b json
         To evaluate if the hvac system is modeled as Sys-4 in the B_rmd.
     hvac_b_id list
