from rct229.rulesets.ashrae9012022.ruleset_functions.baseline_systems.baseline_hvac_test_util import (
...
def test__TEST_RMD_baseline_system_4__is_valid():
    schema_validation_result = schema_validate_rpd(SYS_4_TEST_RMD)
