...
class PRM9012022Rule40i48(RuleDefinitionListIndexedBase):
    """Rule 8 of ASHRAE 90.1-2022 Appendix G Section 11 (Service Water Heating)"""

    def __init__(self):
        super(PRM9012022Rule40i48, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule40i48.RMDRule(),
    ...
    class RMDRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule40i48.RMDRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False,
                    BASELINE_0=True,
                    PROPOSED=True,
                ...
                index_rmd=BASELINE_0,
                each_rule=PRM9012022Rule40i48.RMDRule.SWHBATRule(),
            )
        ...
        class SWHBATRule(RuleDefinitionBase):
            def __init__(self):
                super(PRM9012022Rule40i48.RMDRule.SWHBATRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=True
                    ),
                )
