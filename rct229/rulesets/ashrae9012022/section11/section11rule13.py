...
class PRM9012022Rule51s51(RuleDefinitionListIndexedBase):
    """Rule 13 of ASHRAE 90.1-2022 Appendix G Section 11 (Service Water Heating)"""

    def __init__(self):
        super(PRM9012022Rule51s51, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule51s51.RMDRule(),
    ...
    class RMDRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule51s51.RMDRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
                index_rmd=BASELINE_0,
                each_rule=PRM9012022Rule51s51.RMDRule.BuildingRule(),
                list_path="$.buildings[*]",
            )
        ...
        class BuildingRule(PartialRuleDefinition):
            def __init__(self):
                super(PRM9012022Rule51s51.RMDRule.BuildingRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=False
                    ),
