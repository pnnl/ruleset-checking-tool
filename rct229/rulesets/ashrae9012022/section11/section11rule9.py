...
from rct229.rulesets.ashrae9012022.ruleset_functions.get_swh_bats_and_swh_use import (
    get_swh_bats_and_swh_use,
)
from rct229.utils.jsonpath_utils import find_all


class PRM9012022Rule93n40(RuleDefinitionListIndexedBase):
    """Rule 9 of ASHRAE 90.1-2022 Appendix G Section 11 (Service Water Heating)"""

    def __init__(self):
        super(PRM9012022Rule93n40, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule93n40.RMDRule(),
            index_rmd=BASELINE_0,
            id="11-9",
            description="The baseline system must be sized according to Standard 90.1 2022, Section 7.4.1.",
    ...
    class RMDRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule93n40.RMDRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False,
                    BASELINE_0=True,
                    PROPOSED=False,
                ...
                index_rmd=BASELINE_0,
                each_rule=PRM9012022Rule93n40.RMDRule.SWHBATRule(),
            )
        ...
        class SWHBATRule(PartialRuleDefinition):
            def __init__(self):
                super(PRM9012022Rule93n40.RMDRule.SWHBATRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=False
                    ),
                )
            ...
            def get_manual_check_required_msg(self, context, calc_vals=None, data=None):
                ...
                return f"Check that the baseline Service Water Heating System for Building Area Type {swh_bat} is sized according to ASHRAE Standard 90.1 2022, Section 7.4.1."
