...
class PRM9012022Rule29n09(RuleDefinitionListIndexedBase):
    """Rule 6 of ASHRAE 90.1-2022 Appendix G Section 11 (Service Water Heating)"""

    def __init__(self):
        super(PRM9012022Rule29n09, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule29n09.RMDRule(),
    ...
    class RMDRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule29n09.RMDRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
                each_rule=PRM9012022Rule29n09.RMDRule.SWHDistRule(),
                index_rmd=BASELINE_0,
        ...
        class SWHDistRule(RuleDefinitionBase):
            def __init__(self):
                super(PRM9012022Rule29n09.RMDRule.SWHDistRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False,
                        BASELINE_0=True,
                        PROPOSED=False,
