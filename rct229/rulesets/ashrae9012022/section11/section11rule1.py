...
class PRM9012022Rule72v93(RuleDefinitionListIndexedBase):
    """Rule 1 of ASHRAE 90.1-2022 Appendix G Section 11 (Service Water Heating)"""

    def __init__(self):
        super(PRM9012022Rule72v93, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=True, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule72v93.RMDRule(),
    ...
    class RMDRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule72v93.RMDRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=True, BASELINE_0=True, PROPOSED=True
                ),
            )
