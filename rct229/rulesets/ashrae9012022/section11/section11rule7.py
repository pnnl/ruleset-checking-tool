...
from rct229.rulesets.ashrae9012022.data_fns.table_G3_1_1_2_fns import (
    table_g3_1_2_lookup,
)
...
class PRM9012022Rule49y39(RuleDefinitionListIndexedBase):
    """Rule 7 of ASHRAE 90.1-2022 Appendix G Section 11 (Service Water Heating)"""

    def __init__(self):
        super(PRM9012022Rule49y39, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule49y39.RMDRule(),
    ...
    class RMDRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule49y39.RMDRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False,
                    BASELINE_0=True,
                    PROPOSED=True,
                ...
                index_rmd=BASELINE_0,
                each_rule=PRM9012022Rule49y39.RMDRule.SWHBATRule(),
            )
        ...
        class SWHBATRule(RuleDefinitionBase):
            def __init__(self):
                super(PRM9012022Rule49y39.RMDRule.SWHBATRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=True
                    ),
                )
