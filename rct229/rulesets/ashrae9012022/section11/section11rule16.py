...
from rct229.rulesets.ashrae9012022.ruleset_functions.get_fuels_modeled_in_rmd import (
...
class PRM9012022Rule23k17(RuleDefinitionListIndexedBase):
    """Rule 16 of ASHRAE 90.1-2022 Appendix G Section 11 (Service Water Heating)"""

    def __init__(self):
        super(PRM9012022Rule23k17, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule23k17.RMDRule(),
    ...
    class RMDRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule23k17.RMDRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                each_rule=PRM9012022Rule23k17.RMDRule.SWHEquipRule(),
                index_rmd=BASELINE_0,
        ...
        class SWHEquipRule(RuleDefinitionBase):
            def __init__(self):
                super(PRM9012022Rule23k17.RMDRule.SWHEquipRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False,
                        BASELINE_0=True,
                        PROPOSED=False,
