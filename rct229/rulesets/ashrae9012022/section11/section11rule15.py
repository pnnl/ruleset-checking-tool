...
class PRM9012022Rule06k20(RuleDefinitionListIndexedBase):
    """Rule 15 of ASHRAE 90.1-2022 Appendix G Section 11 (Service Water Heating)"""

    def __init__(self):
        super(PRM9012022Rule06k20, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule06k20.RMDRule(),
    ...
    class RMDRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule06k20.RMDRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                each_rule=PRM9012022Rule06k20.RMDRule.SWHUseRule(),
                index_rmd=BASELINE_0,
        ...
        class SWHUseRule(RuleDefinitionBase):
            def __init__(self):
                super(PRM9012022Rule06k20.RMDRule.SWHUseRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=True
                    ),
