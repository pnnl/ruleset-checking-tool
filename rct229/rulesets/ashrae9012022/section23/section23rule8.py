...
class PRM9012022Rule45r08(RuleDefinitionListIndexedBase):
    """Rule 8 of ASHRAE 90.1-2022 Appendix G Section 23 (Air-side)"""

    def __init__(self):
        super(PRM9012022Rule45r08, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule45r08.HVACRule(),
    ...
    class HVACRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule45r08.HVACRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
                each_rule=PRM9012022Rule45r08.HVACRule.SupplyFanRule(),
                index_rmd=BASELINE_0,
        ...
        class SupplyFanRule(RuleDefinitionBase):
            def __init__(self):
                super(PRM9012022Rule45r08.HVACRule.SupplyFanRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=False
                    ),
                    required_fields={
