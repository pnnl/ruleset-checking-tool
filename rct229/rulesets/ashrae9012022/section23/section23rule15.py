...
class PRM9012022Rule71f87(RuleDefinitionListIndexedBase):
    """Rule 15 of ASHRAE 90.1-2022 Appendix G Section 23 (Air-side)"""

    def __init__(self):
        super(PRM9012022Rule71f87, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule71f87.HVACRule(),
            index_rmd=PROPOSED,
            id="23-15",
    ...
    class HVACRule(PartialRuleDefinition):
        def __init__(self):
            super(PRM9012022Rule71f87.HVACRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
