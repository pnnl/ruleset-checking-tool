...
class PRM9012022Rule50v48(RuleDefinitionListIndexedBase):
    """Rule 13 of ASHRAE 90.1-2022 Appendix G Section 23 (Air-side)"""

    def __init__(self):
        super(PRM9012022Rule50v48, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule50v48.HVACRule(),
            index_rmd=PROPOSED,
            id="23-13",
    ...
    class HVACRule(PartialRuleDefinition):
        def __init__(self):
            super(PRM9012022Rule50v48.HVACRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
