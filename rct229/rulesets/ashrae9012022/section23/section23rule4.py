...
class PRM9012022Rule68z84(RuleDefinitionListIndexedBase):
    """Rule 4 of ASHRAE 90.1-2022 Appendix G Section 23 (Air-side)"""

    def __init__(self):
        super(PRM9012022Rule68z84, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule68z84.RuleSetModelInstanceRule(),
    ...
    class RuleSetModelInstanceRule(PartialRuleDefinition):
        def __init__(self):
            super(PRM9012022Rule68z84.RuleSetModelInstanceRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
            )
