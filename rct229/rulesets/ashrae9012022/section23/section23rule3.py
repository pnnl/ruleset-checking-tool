...
class PRM9012022Rule44u85(RuleDefinitionListIndexedBase):
    """Rule 3 of ASHRAE 90.1-2022 Appendix G Section 23 (Air-side)"""

    def __init__(self):
        super(PRM9012022Rule44u85, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule44u85.TerminalRule(),
    ...
    class TerminalRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule44u85.TerminalRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                required_fields={
