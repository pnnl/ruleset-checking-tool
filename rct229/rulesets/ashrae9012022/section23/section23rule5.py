...
class PRM9012022Rule69z86(RuleDefinitionListIndexedBase):
    """Rule 5 of ASHRAE 90.1-2022 Appendix G Section 23 (Air-side)"""

    def __init__(self):
        super(PRM9012022Rule69z86, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule69z86.TerminalRule(),
    ...
    class TerminalRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule69z86.TerminalRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
            )
