...
class PRM9012022Rule86j27(RuleDefinitionListIndexedBase):
    """Rule 1 of ASHRAE 90.1-2022 Appendix G Section 10 (HVAC General)"""

    def __init__(self):
        super(PRM9012022Rule86j27, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule86j27.ZoneRule(),
    ...
    class ZoneRule(PartialRuleDefinition):
        def __init__(self):
            super(PRM9012022Rule86j27.ZoneRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
            )
        ...
        def get_manual_check_required_msg(self, context, calc_vals=None, data=None):
            ...
            if zone_has_humidification_bool_b and zone_has_humidification_bool_p:
                UNDETERMINED_MSG = (
                    ...
                    "if the specified humidification system complies with 90.1 - 2022 Section 6.5.2.4, and that the baseline system serving this zone is modeled with non-adiabatic humidification "
