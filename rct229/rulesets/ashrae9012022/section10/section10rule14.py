...
from rct229.rulesets.ashrae9012022.data_fns.table_G3_5_2_fns import (
    HeatPumpEquipmentType,
    RatingCondition,
    table_g3_5_2_lookup,
)
from rct229.rulesets.ashrae9012022.data_fns.table_G3_5_4_fns import table_g3_5_4_lookup
from rct229.rulesets.ashrae9012022.data_fns.table_G3_5_5_fns import (
...
class PRM9012022Rule10p28(RuleDefinitionListIndexedBase):
    """Rule 14 of ASHRAE 90.1-2022 Appendix G Section 10 (HVAC General)"""

    def __init__(self):
        super(PRM9012022Rule10p28, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule10p28.HVACRule(),
    ...
    class HVACRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule10p28.HVACRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
                required_fields={
