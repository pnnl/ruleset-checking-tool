...
class PRM9012022Rule51z38(RuleDefinitionBase):
    """Rule 9 of ASHRAE 90.1-2022 Appendix G Section 1 (Performance Calculation)"""

    def __init__(self):
        super(PRM9012022Rule51z38, self).__init__(
