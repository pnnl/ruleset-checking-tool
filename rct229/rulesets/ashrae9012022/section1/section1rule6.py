...
class PRM9012022Rule10d53(RuleDefinitionListIndexedBase):
    """Rule 6 of ASHRAE 90.1-2022 Appendix G Section 1 (Performance Calculation)"""

    def __init__(self):
        super(PRM9012022Rule10d53, self).__init__(
            ...
            each_rule=PRM9012022Rule10d53.RMDRule(),
            list_path="ruleset_model_descriptions[0]",
        )

    class RMDRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule10d53.RMDRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False,
                    BASELINE_0=True,
                    BASELINE_90=True,
