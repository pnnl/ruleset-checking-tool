...
from rct229.rulesets.ashrae9012022.data_fns.extra_schema_fns import proposed_equals_user


class PRM9012022Rule71o26(RuleDefinitionBase):
    """Rule 8 of ASHRAE 90.1-2022 Appendix G Section 1 (Performance Calculation)"""

    def __init__(self):
        super(PRM9012022Rule71o26, self).__init__(
