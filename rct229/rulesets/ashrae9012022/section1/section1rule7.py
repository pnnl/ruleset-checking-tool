...
class PRM9012022Rule37e66(RuleDefinitionBase):
    """Rule 7 of ASHRAE 90.1-2022 Appendix G Section 1 (Performance Calculation)"""

    def __init__(self):
        super(PRM9012022Rule37e66, self).__init__(
