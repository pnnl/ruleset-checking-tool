...
class PRM9012022Rule88z11(RuleDefinitionBase):
    """Rule 3 of ASHRAE 90.1-2022 Appendix G Section 1 (Performance Calculations)"""

    def __init__(self):
        super(PRM9012022Rule88z11, self).__init__(
