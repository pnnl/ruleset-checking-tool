...
class PRM9012022Rule86h31(RuleDefinitionBase):
    """Rule 5 of ASHRAE 90.1-2022 Appendix G Section 1 (Performance Calculations)"""

    def __init__(self):
        super(PRM9012022Rule86h31, self).__init__(
