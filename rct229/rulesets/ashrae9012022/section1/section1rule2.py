...
class PRM9012022Rule63e94(RuleDefinitionBase):
    """Rule 2 of ASHRAE 90.1-2022 Appendix G Section 1 (Performance Calculations)"""

    def __init__(self):
        super(PRM9012022Rule63e94, self).__init__(
            ...
            id="1-2",
            description="The performance of the proposed design is calculated in accordance with Standard 90.1-2022 Appendix G, where Performance Cost Index = Proposed building performance (PBP) /Baseline building performance (BBP), "
