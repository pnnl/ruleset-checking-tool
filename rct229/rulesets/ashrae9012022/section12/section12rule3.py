...
class PRM9012022Rule79w60(RuleDefinitionListIndexedBase):
    """Rule 3 of ASHRAE 90.1-2022 Appendix G Section 12 (Receptacle)"""

    def __init__(self):
        super(PRM9012022Rule79w60, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule79w60.RuleSetModelDescriptionRule(),
            index_rmd=PROPOSED,
            id="12-3",
            description="When receptacle controls are specified in the proposed building design for spaces where not required by Standard 90.1 2022 Section 8.4.2, "
            "the hourly receptacle schedule shall be reduced as specified in Standard 90.1-2022 Table G3.1 Section 12 Proposed Building Performance column.",
    ...
    class RuleSetModelDescriptionRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule79w60.RuleSetModelDescriptionRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                each_rule=PRM9012022Rule79w60.RuleSetModelDescriptionRule.SpaceRule(),
                index_rmd=PROPOSED,
        ...
        class SpaceRule(RuleDefinitionListIndexedBase):
            def __init__(self):
                super(
                    PRM9012022Rule79w60.RuleSetModelDescriptionRule.SpaceRule, self
                ).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=True
                    ),
                    each_rule=PRM9012022Rule79w60.RuleSetModelDescriptionRule.SpaceRule.MiscEquipRule(),
                    index_rmd=PROPOSED,
            ...
            class MiscEquipRule(RuleDefinitionBase):
                def __init__(self):
                    super(
                        PRM9012022Rule79w60.RuleSetModelDescriptionRule.SpaceRule.MiscEquipRule,
                        self,
                    ).__init__(
                        rmds_used=produce_ruleset_model_description(
                            USER=False, BASELINE_0=True, PROPOSED=True
