...
class PRM9012022Rule88h78(RuleDefinitionListIndexedBase):
    """Rule 1 of ASHRAE 90.1-2022 Appendix G Section 12 (Receptacle)"""

    def __init__(self):
        super(PRM9012022Rule88h78, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule88h78.RMDRule(),
    ...
    class RMDRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule88h78.RMDRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
