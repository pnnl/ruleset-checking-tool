...
class PRM9012022Rule60e48(RuleDefinitionListIndexedBase):
    """Rule 4 of ASHRAE 90.1-2022 Appendix G Section 12 (Receptacle)"""

    def __init__(self):
        super(PRM9012022Rule60e48, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule60e48.RuleSetModelDescriptionRule(),
    ...
    class RuleSetModelDescriptionRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule60e48.RuleSetModelDescriptionRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
                each_rule=PRM9012022Rule60e48.RuleSetModelDescriptionRule.MiscEquipRule(),
                index_rmd=BASELINE_0,
        ...
        class MiscEquipRule(RuleDefinitionBase):
            def __init__(self):
                super(
                    PRM9012022Rule60e48.RuleSetModelDescriptionRule.MiscEquipRule, self
                ).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=False
                    ),
