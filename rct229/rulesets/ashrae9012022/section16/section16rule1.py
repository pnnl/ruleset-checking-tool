...
from rct229.rulesets.ashrae9012022.data_fns.table_G3_9_1_fins import table_G3_9_1_lookup
from rct229.rulesets.ashrae9012022.data_fns.table_G3_9_2_fins import table_G3_9_2_lookup
from rct229.rulesets.ashrae9012022.data_fns.table_G3_9_3_fins import table_G3_9_3_lookup
...
class PRM9012022Rule98t42(RuleDefinitionListIndexedBase):
    """Rule 1 of ASHRAE 90.1-2022 Appendix G Section 16 (Elevators)"""

    def __init__(self):
        super(PRM9012022Rule98t42, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False,
                BASELINE_0=True,
                PROPOSED=True,
            ),
            each_rule=PRM9012022Rule98t42.ElevatorRule(),
    ...
    class ElevatorRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule98t42.ElevatorRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False,
                    BASELINE_0=True,
                    PROPOSED=False,
