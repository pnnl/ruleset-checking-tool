...
class PRM9012022Rule55z67(RuleDefinitionListIndexedBase):
    """Rule 5 of ASHRAE 90.1-2022 Appendix G Section 16 (Elevators)"""

    def __init__(self):
        super(PRM9012022Rule55z67, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False,
                BASELINE_0=True,
                PROPOSED=True,
            ),
            each_rule=PRM9012022Rule55z67.RuleSetModelDescriptionRule(),
    ...
    class RuleSetModelDescriptionRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule55z67.RuleSetModelDescriptionRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                each_rule=PRM9012022Rule55z67.RuleSetModelDescriptionRule.ElevatorRule(),
                index_rmd=BASELINE_0,
        ...
        class ElevatorRule(RuleDefinitionBase):
            def __init__(self):
                super(
                    PRM9012022Rule55z67.RuleSetModelDescriptionRule.ElevatorRule, self
                ).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False,
                        BASELINE_0=True,
