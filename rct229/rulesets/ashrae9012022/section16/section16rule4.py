...
class PRM9012022Rule03a79(RuleDefinitionListIndexedBase):
    """Rule 4 of ASHRAE 90.1-2022 Appendix G Section 16 (Elevators)"""

    def __init__(self):
        super(PRM9012022Rule03a79, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False,
                BASELINE_0=False,
                PROPOSED=True,
            ),
            each_rule=PRM9012022Rule03a79.RuleSetModelDescriptionRule(),
            index_rmd=PROPOSED,
            id="16-4",
    ...
    class RuleSetModelDescriptionRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule03a79.RuleSetModelDescriptionRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=False, PROPOSED=True
                ),
                each_rule=PRM9012022Rule03a79.RuleSetModelDescriptionRule.ElevatorRule(),
                index_rmd=PROPOSED,
        ...
        class ElevatorRule(RuleDefinitionBase):
            def __init__(self):
                super(
                    PRM9012022Rule03a79.RuleSetModelDescriptionRule.ElevatorRule, self
                ).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False,
                        BASELINE_0=False,
