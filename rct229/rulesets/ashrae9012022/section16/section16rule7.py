...
class PRM9012022Rule30t80(RuleDefinitionListIndexedBase):
    """Rule 7 of ASHRAE 90.1-2022 Appendix G Section 16 (Elevators)"""

    def __init__(self):
        super(PRM9012022Rule30t80, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule30t80.ElevatorRule(),
    ...
    class ElevatorRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule30t80.ElevatorRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
