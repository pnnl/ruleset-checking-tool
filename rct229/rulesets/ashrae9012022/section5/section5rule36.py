...
class PRM9012022Rule23m90(RuleDefinitionListIndexedBase):
    """Rule 36 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule23m90, self).__init__(
            ...
            each_rule=PRM9012022Rule23m90.BuildingRule(),
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule23m90.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                each_rule=PRM9012022Rule23m90.BuildingRule.ZoneRule(),
                index_rmd=BASELINE_0,
        ...
        class ZoneRule(RuleDefinitionBase):
            def __init__(self):
                super(PRM9012022Rule23m90.BuildingRule.ZoneRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=True
                    ),
                    required_fields={
