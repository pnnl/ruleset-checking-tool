...
class PRM9012022Rule42c42(RuleDefinitionListIndexedBase):
    """Rule 28 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        ...
        class RoofRule(RuleDefinitionListIndexedBase):
            def __init__(self):
                super(PRM9012022Rule42c42.BuildingRule.RoofRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=False
                    ),
                    each_rule=PRM9012022Rule42c42.BuildingRule.RoofRule.SubsurfaceRule(),
                    index_rmd=BASELINE_0,
            ...
            class SubsurfaceRule(RuleDefinitionBase):
                def __init__(self):
                    super(
                        PRM9012022Rule42c42.BuildingRule.RoofRule.SubsurfaceRule, self
                    ).__init__(
                        rmds_used=produce_ruleset_model_description(
                            USER=False, BASELINE_0=True, PROPOSED=False
                        ),
