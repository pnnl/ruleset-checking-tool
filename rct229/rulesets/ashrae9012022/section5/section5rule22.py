...
class PRM9012022Rule50p59(RuleDefinitionListIndexedBase):
    """Rule 22 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule50p59, self).__init__(
            ...
            each_rule=PRM9012022Rule50p59.BuildingRule(),
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule50p59.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
                each_rule=PRM9012022Rule50p59.BuildingRule.AboveGradeWallRule(),
                index_rmd=BASELINE_0,
        ...
        class AboveGradeWallRule(RuleDefinitionListIndexedBase):
            def __init__(self):
                super(
                    PRM9012022Rule50p59.BuildingRule.AboveGradeWallRule, self
                ).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=False
                    ),
                    list_path="subsurfaces[*]",
                    each_rule=PRM9012022Rule50p59.BuildingRule.AboveGradeWallRule.SubsurfaceRule(),
                    index_rmd=BASELINE_0,
                )
            ...
            class SubsurfaceRule(RuleDefinitionBase):
                def __init__(self):
                    super(
                        PRM9012022Rule50p59.BuildingRule.AboveGradeWallRule.SubsurfaceRule,
                        self,
                    ).__init__(
                        rmds_used=produce_ruleset_model_description(
                            USER=False, BASELINE_0=True, PROPOSED=False
                ...
                def get_calc_vals(self, context, data=None):
                    ...
                    return {
                        ...
                        "depth_of_overhang": CalcQ(
                            "length", subsurface_b.get("depth_of_overhang")
                        ),
                    }
