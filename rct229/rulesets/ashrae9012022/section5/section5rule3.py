...
class PRM9012022Rule73o42(RuleDefinitionListIndexedBase):
    """Rule 3 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule73o42, self).__init__(
            ...
            each_rule=PRM9012022Rule73o42.BuildingRule(),
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule73o42.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                required_fields={},
                each_rule=PRM9012022Rule73o42.BuildingRule.SurfaceRule(),
                index_rmd=BASELINE_0,
        ...
        class SurfaceRule(PartialRuleDefinition):
            def __init__(self):
                super(PRM9012022Rule73o42.BuildingRule.SurfaceRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
