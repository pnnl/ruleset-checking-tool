...
class PRM9012022Rule82y74(RuleDefinitionListIndexedBase):
    """Rule 18 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule82y74, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=False, PROPOSED=True
            ),
            each_rule=PRM9012022Rule82y74.SubsurfaceRule(),
            index_rmd=PROPOSED,
            id="5-18",
    ...
    class SubsurfaceRule(PartialRuleDefinition):
        def __init__(self):
            super(PRM9012022Rule82y74.SubsurfaceRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=False, PROPOSED=True
                ),
