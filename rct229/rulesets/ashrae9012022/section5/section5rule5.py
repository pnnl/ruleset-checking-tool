...
class PRM9012022Rule02s62(RuleDefinitionListIndexedBase):
    """Rule 5 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule02s62, self).__init__(
            ...
            each_rule=PRM9012022Rule02s62.BuildingRule(),
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule02s62.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                each_rule=PRM9012022Rule02s62.BuildingRule.SurfaceRule(),
                index_rmd=BASELINE_0,
        ...
        class SurfaceRule(PartialRuleDefinition):
            def __init__(self):
                super(PRM9012022Rule02s62.BuildingRule.SurfaceRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
