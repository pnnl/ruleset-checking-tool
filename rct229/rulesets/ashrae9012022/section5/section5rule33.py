...
class PRM9012022Rule45p36(RuleDefinitionListIndexedBase):
    """Rule 33 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule45p36, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=False
            ),
            each_rule=PRM9012022Rule45p36.BuildingRule(),
    ...
    class BuildingRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule45p36.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
                required_fields={
