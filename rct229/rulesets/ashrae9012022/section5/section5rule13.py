...
class PRM9012022Rule73r04(RuleDefinitionListIndexedBase):
    """Rule 13 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule73r04, self).__init__(
            ...
            each_rule=PRM9012022Rule73r04.BuildingRule(),
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule73r04.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                required_fields={},
                each_rule=PRM9012022Rule73r04.BuildingRule.UnregulatedSurfaceRule(),
                index_rmd=BASELINE_0,
        ...
        def create_data(self, context, data=None):
            ...
            return {
                "surface_conditioning_category_dict": get_surface_conditioning_category_dict(
                    data["climate_zone"], building, data["constructions_b"], BASELINE_0
                ),
            }
        ...
        class UnregulatedSurfaceRule(RuleDefinitionBase):
            def __init__(self):
                super(
                    PRM9012022Rule73r04.BuildingRule.UnregulatedSurfaceRule, self
                ).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=True
                    ),
