...
from rct229.rulesets.ashrae9012022.data_fns.table_G3_111_fns import (
...
class PRM9012022Rule67j71(RuleDefinitionListIndexedBase):
    """Rule 14 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule67j71, self).__init__(
            ...
            each_rule=PRM9012022Rule67j71.BuildingRule(),
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule67j71.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
                required_fields={
                ...
                index_rmd=BASELINE_0,
                each_rule=PRM9012022Rule67j71.BuildingRule.AreaTypeRule(),
            )
        ...
        class AreaTypeRule(RuleDefinitionBase):
            def __init__(self):
                super(PRM9012022Rule67j71.BuildingRule.AreaTypeRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=False
                    ),
                    precision={
