...
class PRM9012022Rule69v04(RuleDefinitionListIndexedBase):
    """Rule 27 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule69v04, self).__init__(
            ...
            each_rule=PRM9012022Rule69v04.BuildingRule(),
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        ...
        class RoofRule(RuleDefinitionListIndexedBase):
            def __init__(self):
                super(PRM9012022Rule69v04.BuildingRule.RoofRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=False
                    ),
                    each_rule=PRM9012022Rule69v04.BuildingRule.RoofRule.SubsurfaceRule(),
                    index_rmd=BASELINE_0,
            ...
            class SubsurfaceRule(RuleDefinitionBase):
                def __init__(self):
                    super(
                        PRM9012022Rule69v04.BuildingRule.RoofRule.SubsurfaceRule, self
                    ).__init__(
                        rmds_used=produce_ruleset_model_description(
                            USER=False, BASELINE_0=True, PROPOSED=False
                        ),
