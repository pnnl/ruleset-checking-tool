...
class PRM9012022Rule77j30(RuleDefinitionListIndexedBase):
    """Rule 1 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule77j30, self).__init__(
            ...
            each_rule=PRM9012022Rule77j30.RMDRule(),
    ...
    class RMDRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule77j30.RMDRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=True,
                    BASELINE_0=True,
                    BASELINE_90=True,
                ...
                each_rule=PRM9012022Rule77j30.RMDRule.BuildingRule(),
                index_rmd=BASELINE_0,
                list_path="$.buildings[*]",
            )
        ...
        class BuildingRule(RuleDefinitionBase):
            def __init__(self):
                super(PRM9012022Rule77j30.RMDRule.BuildingRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        BASELINE_0=True,
                    ),
                    required_fields={
