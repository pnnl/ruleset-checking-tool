...
class PRM9012022Rule78j13(RuleDefinitionListIndexedBase):
    """Rule 24 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule78j13, self).__init__(
            ...
            each_rule=PRM9012022Rule78j13.BuildingRule(),
    ...
    class BuildingRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule78j13.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                precision={
