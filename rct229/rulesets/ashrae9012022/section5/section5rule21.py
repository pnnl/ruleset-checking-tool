...
class PRM9012022Rule44m70(RuleDefinitionListIndexedBase):
    """Rule 21 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule44m70, self).__init__(
            ...
            each_rule=PRM9012022Rule44m70.BuildingRule(),
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule44m70.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                each_rule=PRM9012022Rule44m70.BuildingRule.UnregulatedSurfaceRule(),
                index_rmd=BASELINE_0,
        ...
        class UnregulatedSurfaceRule(RuleDefinitionListIndexedBase):
            def __init__(self):
                super(
                    PRM9012022Rule44m70.BuildingRule.UnregulatedSurfaceRule, self
                ).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=True
                    ),
                    list_path="subsurfaces[*]",
                    each_rule=PRM9012022Rule44m70.BuildingRule.UnregulatedSurfaceRule.UnregulatedSubsurfaceRule(),
                    index_rmd=BASELINE_0,
                )
