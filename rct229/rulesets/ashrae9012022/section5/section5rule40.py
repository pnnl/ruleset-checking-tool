...
class PRM9012022Rule33l08(RuleDefinitionListIndexedBase):
    """Rule 40 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule33l08, self).__init__(
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule33l08.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                each_rule=PRM9012022Rule33l08.BuildingRule.RoofRule(),
                index_rmd=BASELINE_0,
        ...
        class RoofRule(RuleDefinitionBase):
            def __init__(self):
                super(PRM9012022Rule33l08.BuildingRule.RoofRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=True
                    ),
                    precision={
