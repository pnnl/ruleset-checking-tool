...
class PRM9012022Rule50m61(RuleDefinitionListIndexedBase):
    """Rule 39 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule50m61, self).__init__(
            ...
            each_rule=PRM9012022Rule50m61.BuildingRule(),
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule50m61.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
                each_rule=PRM9012022Rule50m61.BuildingRule.SurfaceRule(),
                index_rmd=BASELINE_0,
        ...
        class SurfaceRule(RuleDefinitionListIndexedBase):
            def __init__(self):
                super(PRM9012022Rule50m61.BuildingRule.SurfaceRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=False
                    ),
                    list_path="$.subsurfaces[*]",
                    each_rule=PRM9012022Rule50m61.BuildingRule.SurfaceRule.SubSurfaceRule(),
                    index_rmd=BASELINE_0,
                    required_fields={
                        "$.subsurfaces[*]": [
                            "classification",
            ...
            class SubSurfaceRule(RuleDefinitionBase):
                def __init__(self):
                    super(
                        PRM9012022Rule50m61.BuildingRule.SurfaceRule.SubSurfaceRule,
                        self,
                    ).__init__(
                        rmds_used=produce_ruleset_model_description(
                            USER=False, BASELINE_0=True, PROPOSED=False
