...
class PRM9012022Rule87g56(RuleDefinitionListIndexedBase):
    """Rule 17 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule87g56, self).__init__(
            ...
            each_rule=PRM9012022Rule87g56.ZoneRule(),
    ...
    class ZoneRule(PartialRuleDefinition):
        def __init__(self):
            super(PRM9012022Rule87g56.ZoneRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=False
                ),
            )
