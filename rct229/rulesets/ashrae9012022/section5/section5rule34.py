...
class PRM9012022Rule69u47(RuleDefinitionListIndexedBase):
    """Rule 34 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule69u47, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule69u47.BuildingRule(),
            index_rmd=PROPOSED,
            id="5-34",
    ...
    class BuildingRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule69u47.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                required_fields={
