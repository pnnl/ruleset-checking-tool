...
class PRM9012022Rule29j06(RuleDefinitionListIndexedBase):
    """Rule 10 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""
    ...
    def __init__(self):
        super(PRM9012022Rule29j06, self).__init__(
            ...
            each_rule=PRM9012022Rule29j06.BuildingRule(),
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        ...
        class FloorRule(RuleDefinitionBase):
            def __init__(self):
                super(PRM9012022Rule29j06.BuildingRule.FloorRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=False
                    ),
