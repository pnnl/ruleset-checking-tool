...
class PRM9012022Rule48w84(RuleDefinitionListIndexedBase):
    """Rule 31 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule48w84, self).__init__(
            ...
            each_rule=PRM9012022Rule48w84.BuildingRule(),
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        ...
        class RoofRule(RuleDefinitionBase):
            def __init__(self):
                super(PRM9012022Rule48w84.BuildingRule.RoofRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=False
                    ),
                    required_fields={
