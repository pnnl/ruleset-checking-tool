...
class PRM9012022Rule48v87(RuleDefinitionListIndexedBase):
    """Rule 8 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule48v87, self).__init__(
            ...
            each_rule=PRM9012022Rule48v87.BuildingRule(),
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule48v87.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                required_fields={},
                each_rule=PRM9012022Rule48v87.BuildingRule.AboveGradeWallRule(),
                index_rmd=BASELINE_0,
        ...
        class AboveGradeWallRule(RuleDefinitionBase):
            def __init__(self):
                super(
                    PRM9012022Rule48v87.BuildingRule.AboveGradeWallRule, self
                ).__init__(
                    rmds_used=produce_ruleset_model_description(
            ...
            def get_calc_vals(self, context, data=None):
                ...
                constructions = data["constructions_b"]
