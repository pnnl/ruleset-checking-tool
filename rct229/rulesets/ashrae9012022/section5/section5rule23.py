...
class PRM9012022Rule11q41(RuleDefinitionListIndexedBase):
    """Rule 23 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule11q41, self).__init__(
            rmds_used=produce_ruleset_model_description(
                USER=False, BASELINE_0=True, PROPOSED=True
            ),
            each_rule=PRM9012022Rule11q41.BuildingRule(),
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule11q41.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                list_path="$.building_segments[*].zones[*].surfaces[*].subsurfaces[*]",
                each_rule=PRM9012022Rule11q41.BuildingRule.SubsurfaceRule(),
                index_rmd=BASELINE_0,
            )
        ...
        class SubsurfaceRule(RuleDefinitionBase):
            def __init__(self):
                super(PRM9012022Rule11q41.BuildingRule.SubsurfaceRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=True
                    ),
