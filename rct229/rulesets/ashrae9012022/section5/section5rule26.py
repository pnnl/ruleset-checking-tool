...
class PRM9012022Rule34b75(RuleDefinitionListIndexedBase):
    """Rule 26 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule34b75, self).__init__(
            ...
            each_rule=PRM9012022Rule34b75.BuildingRule(),
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule34b75.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=True, PROPOSED=True
                ),
                each_rule=PRM9012022Rule34b75.BuildingRule.BuildingSegmentRule(),
                index_rmd=BASELINE_0,
        ...
        class BuildingSegmentRule(RuleDefinitionListIndexedBase):
            def __init__(self):
                super(
                    PRM9012022Rule34b75.BuildingRule.BuildingSegmentRule, self
                ).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=True
                    ),
                    each_rule=PRM9012022Rule34b75.BuildingRule.BuildingSegmentRule.RoofRule(),
                    index_rmd=BASELINE_0,
            ...
            class RoofRule(RuleDefinitionBase):
                def __init__(self):
                    super(
                        PRM9012022Rule34b75.BuildingRule.BuildingSegmentRule.RoofRule,
                        self,
                    ).__init__(
                        rmds_used=produce_ruleset_model_description(
                            USER=False, BASELINE_0=True, PROPOSED=True
