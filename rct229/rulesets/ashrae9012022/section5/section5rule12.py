...
class PRM9012022Rule40d86(RuleDefinitionListIndexedBase):
    """Rule 12 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""
    ...
    def __init__(self):
        super(PRM9012022Rule40d86, self).__init__(
            ...
            each_rule=PRM9012022Rule40d86.BuildingRule(),
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        ...
        class SlabOnGradeFloorRule(RuleDefinitionBase):
            def __init__(self):
                super(
                    PRM9012022Rule40d86.BuildingRule.SlabOnGradeFloorRule, self
                ).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=False, BASELINE_0=True, PROPOSED=False
                    ),
