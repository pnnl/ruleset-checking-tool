...
class PRM9012022Rule18s99(RuleDefinitionListIndexedBase):
    """Rule 30 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule18s99, self).__init__(
            ...
            each_rule=PRM9012022Rule18s99.BuildingRule(),
            index_rmd=PROPOSED,
            id="5-30",
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule18s99.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=True, BASELINE_0=False, PROPOSED=True
                ),
                each_rule=PRM9012022Rule18s99.BuildingRule.RoofRule(),
                index_rmd=PROPOSED,
        ...
        class RoofRule(RuleDefinitionBase):
            def __init__(self):
                super(PRM9012022Rule18s99.BuildingRule.RoofRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=True, BASELINE_0=False, PROPOSED=True
                    ),
                    required_fields={
