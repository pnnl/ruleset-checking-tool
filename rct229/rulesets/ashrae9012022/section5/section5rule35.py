...
class PRM9012022Rule39k65(RuleDefinitionListIndexedBase):
    """Rule 35 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""
    ...
    def __init__(self):
        super(PRM9012022Rule39k65, self).__init__(
            ...
            each_rule=PRM9012022Rule39k65.BuildingRule(),
    ...
    class BuildingRule(RuleDefinitionBase):
        ...
        def get_calc_vals(self, context, data=None):
            ...
            scc_dict_b = get_baseline_surface_conditioning_category_dict(
                data["climate_zone"], building_b, data["constructions_b"], building_b, data["constructions_p"]
            )
