...
class PRM9012022Rule67a77(RuleDefinitionListIndexedBase):
    """Rule 37 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule67a77, self).__init__(
            ...
            each_rule=PRM9012022Rule67a77.BuildingRule(),
            index_rmd=PROPOSED,
            id="5-37",
    ...
    class BuildingRule(RuleDefinitionBase):
        def __init__(self):
            super(PRM9012022Rule67a77.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=False, BASELINE_0=False, PROPOSED=True
                ),
