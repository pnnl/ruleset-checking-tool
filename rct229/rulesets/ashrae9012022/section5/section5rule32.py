...
class PRM9012022Rule78r30(RuleDefinitionListIndexedBase):
    """Rule 32 of ASHRAE 90.1-2022 Appendix G Section 5 (Envelope)"""

    def __init__(self):
        super(PRM9012022Rule78r30, self).__init__(
            ...
            each_rule=PRM9012022Rule78r30.BuildingRule(),
            index_rmd=PROPOSED,
            id="5-32",
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        def __init__(self):
            super(PRM9012022Rule78r30.BuildingRule, self).__init__(
                rmds_used=produce_ruleset_model_description(
                    USER=True, BASELINE_0=False, PROPOSED=True
                ),
                each_rule=PRM9012022Rule78r30.BuildingRule.RoofRule(),
                index_rmd=PROPOSED,
        ...
        class RoofRule(RuleDefinitionBase):
            def __init__(self):
                super(PRM9012022Rule78r30.BuildingRule.RoofRule, self).__init__(
                    rmds_used=produce_ruleset_model_description(
                        USER=True, BASELINE_0=False, PROPOSED=True
                    ),
                    required_fields={
