...
class ZoneConditioningCategory:
    ...
    CONDITIONED_MIXED: str = "CONDITIONED_MIXED"
    CONDITIONED_NON_RESIDENTIAL: str = "CONDITIONED_NON_RESIDENTIAL"
    CONDITIONED_RESIDENTIAL: str = "CONDITIONED_RESIDENTIAL"
    SEMI_HEATED: str = "SEMI_HEATED"
