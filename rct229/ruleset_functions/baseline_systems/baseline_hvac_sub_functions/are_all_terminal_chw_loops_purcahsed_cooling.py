...
from rct229.ruleset_functions.baseline_systems.baseline_system_util import find_exactly_one_terminal_unit, \
...
def are_all_terminal_chw_loops_purchased_cooling(rmi_b, terminal_unit_id_list):
    ...
    for terminal_b_id in terminal_unit_id_list:
        ...
        if cooling_from_loop_id:
            ...
            if (
                    getattr_(fluid_loop, "fluid loop", "type") != FLUID_LOOP_TYPE.COOLING
