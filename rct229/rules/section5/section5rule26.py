...
class Section5Rule26(RuleDefinitionListIndexedBase):
    ...
    def __init__(self):
        super(Section5Rule26, self).__init__(
            ...
            list_path="ruleset_model_instance[0].buildings[*]",
        )
    ...
    def create_data(self, context, data=None):
        ...
        for building_b in find_all(self.list_path, rmr_baseline):
            bldg_scc_wwr_ratio_dict[
                building_b["id"]
            ] = get_building_scc_window_wall_ratios_dict(climate, building_b)
    ...
    class BuildingRule(RuleDefinitionListIndexedBase):
        ...
        def create_data(self, context, data=None):
            ...
            bldg_scc_wwr_ratio = data["bldg_scc_wwr_ratio_dict"][building_b["id"]]
            # get all data
            target_shgc_mix = table_G34_lookup(
                climate,
            ...
            target_shgc_nores = table_G34_lookup(
                climate,
                SCC.EXTERIOR_NON_RESIDENTIAL,
                "Vertical Glazing",
            ...
            target_shgc_semiheated = table_G34_lookup(
                ...
                SCC.SEMI_EXTERIOR,
                "Vertical Glazing",
                wwr=bldg_scc_wwr_ratio[SCC.SEMI_EXTERIOR]["solar_heat_gain_coefficient"]
            ...
            class SubsurfaceRule(RuleDefinitionBase):
                ...
                def rule_check(self, context, calc_vals=None, data=None):
                    ...
                    if scc == SCC.EXTERIOR_MIXED:
                        ...
                        target_shgc = data["target_shgc_nores"]
