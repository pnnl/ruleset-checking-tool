...
maximum_capacity_threshold_list = [9999.99, 299.99, 149.99]
...
def table_3_5_3_lookup(compressor_type, capacity):
    ...
    maximum_capacity = maximum_capacity_threshold_list[-1]
    ...
    osstd_entry = find_osstd_table_entry(
        [
            ("cooling_type", compressor_category),
            ("minimum_capacity", minimum_capacity),
            ("maximum_capacity", maximum_capacity),
        ],
        osstd_table=data["ashrae_90_1_table_G3_5_3"],
    )
    minimum_full_load_efficiency_val = osstd_entry["minimum_full_load_efficiency"]
    minimum_integrated_part_load_val = osstd_entry["minimum_integrated_part_load_value"]
