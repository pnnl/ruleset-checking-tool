# HVAC_SystemZoneAssignment - Rule 18-19
**Schema Version:** 0.0.22  
**Mandatory Rule:** True
**Rule ID:** 18-19
**Rule Description:** Residential HVAC zones in CZ 3B, 3C, 4-8A are modeled with system 1 (PTAC)
...
- The target string is: `target_string = "RESIDENTIAL CZ_3b_3c_or_4_to_8"`
- the expected system type is "SYS-1": `expected_system_type = "SYS-1"`
