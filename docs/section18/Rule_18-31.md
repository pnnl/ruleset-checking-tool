# HVAC_SystemZoneAssignment - Rule 18-31
**Schema Version:** 0.0.22  

**Rule ID:** 18-32
**Rule Description:** If the baseline HVAC system serves HVAC zones that includes computer rooms,  baseline system 11 shall be used where the baseline HVAC system type is 7 or 8 and the total computer room peak cooling load is greater than 600,000 BTU/h (175 kW).
...
2. The baseline HVAC system started as Sys 7 or 8
3. Building has peak computer room load between 600,000 btu/hr and 3,000,000/hr
...
## Rule Logic:  
- The target string is: `target_string = "G3_1_1g_part2"
