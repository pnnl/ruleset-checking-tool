...
- Call function to get list of inapplicable HVAC systems: `inapplicable_HVAC_systems_list_p = get_HVAC_systems_applicable_10cd(U_RMR,P_RMR)`
- For each HeatingVentilationAirAconditioningSystem in the P_RMR check if this check is applicable: `for each hvac_p in P_RMR...hvac_systems:`
