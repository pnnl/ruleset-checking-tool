...
- Create a set of the PBP values from the various outputs (it only needs to exist in at least 1 output): `bbp_set = set([B_0_RMD.output.proposed_building_performance_energy_cost, B_90_RMD.output.proposed_building_performance_energy_cost, B_180_RMD.output.proposed_building_performance_energy_cost, B_270_RMD.output.proposed_building_performance_energy_cost, P_RMD.output.proposed_building_performance_energy_cost, U_RMD.output.proposed_building_performance_energy_cost])`
