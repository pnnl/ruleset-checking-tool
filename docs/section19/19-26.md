...
- For each space in the B_RMI: `for space in B_RMI...Space:`  
    ...
    - Case 4: Else if the space type is dwelling unit and all design heating schedules pass then the outcome is NOT_APPLICABLE: `elif is_dwelling_unit == true and all(inf_pass_heating, occ_pass_heating, int_lgt_pass_heating, misc_pass_heating) == true: outcome = "PASS"`  
