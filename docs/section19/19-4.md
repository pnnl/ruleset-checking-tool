...
- For each space in the B_RMI: `for space in B_RMI...Space:`   
    ...
    - Reset space_lighting_space_type_is_defined to true: `space_lighting_space_type_is_defined = true`  
    ...
    - Check if the lighting and ventilation space types are both NOT defined: `if space.lighting_space_type == Null and space._ventilation_space_type == Null: ` 
        - Set space_lighting_space_type_is_defined = false: `space_lighting_space_type_is_defined = false`  
    ...
    - Check if space_lighting_space_type_is_defined = True, if yes carry on with logic, if not go to rule assertions: `if space_lighting_space_type_is_defined = true:`  
