...
2. How do we know for sure if the hvac system is prohibited from recirculating return air by code or accreditation standards? In light of this shoudl we also pass it if OA_CFM_schedule_match == true and its not modeled as 100% OA? I left that in just in case.
