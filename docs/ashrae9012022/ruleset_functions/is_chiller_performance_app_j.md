...
**Inputs:**  
- **Chiller data group**: The chiller object containing all relevant data for the chiller to be validated against the performance curves in Appendix J of ASHRAE 90.1-2022.  This includes the rated capacity, full load efficiency (COP), compressor type, and the lists of capacity and power validation points.
