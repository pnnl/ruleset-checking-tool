...
- Check if RMR has exterior mixed type fenestration: `if rmr_scc_window_wall_ratios_dictionary["EXTERIOR MIXED"] > 0:`
...
- Else, RMR does not have exterior mixed type wall surface: `else:`
