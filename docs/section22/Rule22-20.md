...
**Rule ID:** 22-20  
**Rule Description:** The baseline heat rejection Loop temperature reset = Load Reset.  
...
- For each heat rejection device in B_RMR: `for tower_b in B_RMR.RulesetModelInstance.heat_rejections:`
  ...
  **Rule Assertion:**
  ...
  - Case 1: If heat rejection temperature reset type is load reset: `if tower_b.reset_type == "LOAD_RESET": PASS`
