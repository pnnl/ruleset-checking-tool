...
**Rule ID:** 22-20  
**Rule Description:** The baseline minimum condenser water reset temperature is per Table G3.1.3.11.  
...
- For each heat rejection device in B_RMR: `for tower_b in B_RMR.RulesetModelInstance.heat_rejections:`
  ...
  **Rule Assertion:**
  ...
  - Case 1: If heat rejection minimum reset temperature is per Table G3.1.3.11 `if tower_b.minimum_reset_temperature == tower_leaving_temperature_b: PASS`
