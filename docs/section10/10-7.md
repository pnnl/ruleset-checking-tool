        ...
        - Check if HVAC system is of type 1, 1b, 2, 3, 3b, 4, 5, 5b, 6, or 6b AND that is does not serve more than one floor, if meets criteria then carry on: `if hvac_sys_type_b in ["SYS-1", "SYS-1b", "SYS-2", "SYS-3", "SYS-3b", "SYS-4","SYS-5", "SYS-5b", "SYS-6", "SYS-6b"] and hvac_b.id not in hvac_sys_serve_more_than_one_flr_list_b:` 
            ...
            - For each cooling_system_b in hvac_b: `for cooling_system_b in hvac_b.cooling_system:`
                ...
                - Check else if the system is system type 2: `elif hvac_sys_type_b = "SYS-2":`
                    ...
                    - Check if the modeled efficiency is consistent with this value, if so set boolean variable to true: `if full_load_efficiency_b == COPnf_full_load_eff_b: meets_lower_or_equiv_size_category_eff_b = TRUE`
                - Check else if the system type is 3, 3b (pass if efficiency meets a lower size category or the size category associated with the system):`elif hvac_sys_type_b = "SYS-3" or hvac_sys_type_b = "SYS-3b":`
                ...
                - Check else if the system type is 5, 5b, 6, or 6b (efficiency is expected to be consistent with the size category):`elif hvac_sys_type_b = "SYS-5" or hvac_sys_type_b = "SYS-5b" or hvac_sys_type_b = "SYS-6" or hvac_sys_type_b = "SYS-6b":`
