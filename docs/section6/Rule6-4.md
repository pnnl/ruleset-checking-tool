      ...
      - For each space in zone: `space_b in zone_b.spaces:`  
        ...
        - For each space in zone: `space_b in zone_b.spaces:`  
          ...
          - Look at each lighting object in the space: `for interior_lighting in space_b.interior_lighting:`
            ...
            - check whether the space type is one of the retail space types: `if space.lighting_space_type in? ["RETAIL_FACILITIES_DRESSING_FITTING_ROOM", "RETAIL_FACILITIES_MALL_CONCOURSE", "RETAIL"]:`
