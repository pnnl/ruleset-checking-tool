...
### General ruleset functions
  ...
  * [get_zone_target_baseline_system](ruleset_functions/does_zone_meet_G3_1_1g.md): Following G3.1.1, determines the baseline system type for each zone in a building
...
### G3.1.1 HVAC sub-functions
  ...
  * [is_zone_a_vestibule](ruleset_functions/G311_exceptions/G311_sub_functions/is_zone_a_vestibule.md): following the guidelines in ASHRAE that a vestibule is defined as a space with at least one exterior door and with a surface area of no more than the greater of 50ft2 or 2% of the total area of the floor.
