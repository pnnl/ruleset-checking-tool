...
**Description:** Get the supply, return, exhaust, and relief total fan power, CFM, quantity, and information about whether the pressure drop is consistent across the fans if more than one for a fan system object.   The function returns a dictionary that saves the supply, return, exhaust, and relief fan power as a list, saves the supply, return, exhaust, and relief cfm as a list, saves the supply, return, exhaust, and relief quantity as a list, and saves for each fan whether the pressure drop is undefined, identical, or different across fans (if only one it will return undefined or identical) {"Fan_Power": [supply fan power kW, return fan power kW, exhaust fan power kW, relief fan power kW], "Fan_CFM": [supply fan power CFM, return fan power CFM, exhaust fan power CFM, relief fan power CFM], "Fan_Qty": [supply fan quantity, return fan quantity, exhaust fan quantity, relief fan quantity], "Fan_Pressure": [returns either "IDENTICAL", "UNDEFINED", "DIFFERENT" for supply fans, returns either "IDENTICAL", "UNDEFINED", "DIFFERENT" for return fans, returns either "IDENTICAL", "UNDEFINED", "DIFFERENT" for exhaust fans, returns either "IDENTICAL", "UNDEFINED", "DIFFERENT" for relief fans]}. Values will be equal to zero where not defined for a fan system or as otherwise specified above. For CFM values this function assumes that all fans associated with the supply_fans object are in parallel (i.e., if multiple fans the cfm is additive.) but returns the quantity and information about the pressure drop across fans to help assess whether series or parallel.
...
**Returns:**  
- **get_fan_system_object_supply_return_exhaust_relief_total_kW_CFM**: The function calculates and returns the supply, return, exhaust, and relief total fan power, CFM, quantity, and information about whether the pressure drop is consistent across the fans if more than one for a fan system object.   The function returns a dictionary that saves the supply, return, exhaust, and relief fan power as a list, saves the supply, return, exhaust, and relief cfm as a list, saves the supply, return, exhaust, and relief quantity as a list, and saves for each fan whether the pressure drop is undefined, identical, or different across fans (if only one it will return undefined or identical) {"Fan_Power": [supply fan power kW, return fan power kW, exhaust fan power kW, relief fan power kW], "Fan_CFM": [supply fan power CFM, return fan power CFM, exhaust fan power CFM, relief fan power CFM], "Fan_Qty": [supply fan quantity, return fan quantity, exhaust fan quantity, relief fan quantity], "Fan_Pressure": [returns either "IDENTICAL", "UNDEFINED", "DIFFERENT" for supply fans, returns either "IDENTICAL", "UNDEFINED", "DIFFERENT" for return fans, returns either "IDENTICAL", "UNDEFINED", "DIFFERENT" for exhaust fans, returns either "IDENTICAL", "UNDEFINED", "DIFFERENT" for relief fans]}. Values will be equal to zero where not defined for a fan system or as otherwise specified above. For CFM values this function assumes that all fans associated with the supply_fans object are in parallel (i.e., if multiple fans the cfm is additive.) but returns the quantity and information about the pressure drop across fans to help assess whether series or parallel.
...
- Create dictionary: `get_fan_system_object_supply_return_exhaust_relief_total_kW_CFM = {"Fan_Power": [fan_sys_supply_kW,fan_sys_return_kW,fan_sys_exhaust_kW,fan_sys_relief_kW], "Fan_CFM": [fan_sys_supply_cfm,fan_sys_return_cfm,fan_sys_exhaust_cfm,fan_sys_relief_cfm], "Fan_CFM": [fan_sys_supply_cfm,fan_sys_return_cfm,fan_sys_exhaust_cfm,fan_sys_relief_cfm], "Fan_Qty": [fan_supply_qty, fan_return_qty, fan_exhaust_qty, fan_relief_qty], "Fan_Pressure": [fan_sys_supply_pressure_drop, fan_sys_return_pressure_drop, fan_sys_exhaust_pressure_drop, fan_sys_relief_pressure_drop]}` 
