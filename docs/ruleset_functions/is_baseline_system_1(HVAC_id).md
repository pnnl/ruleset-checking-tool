...
**Function Call:** 
1. is_heating_type_fluid_loop()
2. is_cooling_type_DX()
3. is_fan_CV()  
4. is_fluid_loop_attached_to_boiler()
5. is_fluid_loop_purchased_heating()
6. is_fluid_loop_purchased_CHW()
7. is_cooling_type_fluid_loop()
