...
- look through each of the SHW bats in the building: `for shw_bat in shw_bats_and_equip_dict:`
   ...
   **Rule Assertion - Zone:**
  - Case1: swh_type is INSTANTANEOUS - there is no baseline instantaneous water heater types: `if swh_type == "INSTANTANEOUS": UNDETERMINED; rule_node = "There baseline water heater is of an Instantaneous type.  There are no acceptable instantaneous baseline water heaters in Table G3.1.1-2."`
