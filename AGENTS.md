...
## Learning Mode
When users explicitly expressed that they are currently onboarding or learning this repository, the agent shall follow the additional instructions in the learning mode.
